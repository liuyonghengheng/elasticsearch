...
import static org.elasticsearch.knn.models.Utils.sortedIntersectionCount;
...
public class ExactModel {
    ...
    public static class Jaccard implements SparseBool {
        @Override
        public final double similarity(int[] v1, int[] v2, int totalIndices) {
    ...
    public static class L2 implements DenseFloat {
        @Override
        public final double similarity(float[] v1, float[] v2) {
