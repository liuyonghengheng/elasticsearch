...
public class STConvertCharFilterFactory extends AbstractCharFilterFactory implements NormalizingCharFilterFactory{
    ...
    public STConvertCharFilterFactory(IndexSettings indexSettings, Environment env, String name, Settings settings,String defaultType) {
        super(indexSettings, name);

        String type = settings.get("convert_type", defaultType);
