...
import org.elasticsearch.indexmanagement.indexstatemanagement.action.TransitionsAction
...
import org.elasticsearch.indexmanagement.indexstatemanagement.settings.ManagedIndexSettings.Companion.ALLOW_LIST_NONE
import org.elasticsearch.indexmanagement.indexstatemanagement.settings.ManagedIndexSettings.Companion.DEFAULT_ISM_ENABLED
import org.elasticsearch.indexmanagement.indexstatemanagement.settings.ManagedIndexSettings.Companion.DEFAULT_JOB_INTERVAL
import org.elasticsearch.indexmanagement.indexstatemanagement.settings.ManagedIndexSettings.Companion.DEFAULT_ACTION_VALIDATION_ENABLED
...
import org.elasticsearch.indexmanagement.indexstatemanagement.settings.ManagedIndexSettings.Companion.ACTION_VALIDATION_ENABLED
import org.elasticsearch.indexmanagement.indexstatemanagement.util.DEFAULT_INDEX_TYPE
import org.elasticsearch.indexmanagement.indexstatemanagement.util.MetadataCheck
import org.elasticsearch.indexmanagement.indexstatemanagement.util.checkMetadata
import org.elasticsearch.indexmanagement.indexstatemanagement.util.deleteManagedIndexMetadataRequest
import org.elasticsearch.indexmanagement.indexstatemanagement.util.deleteManagedIndexRequest
import org.elasticsearch.indexmanagement.indexstatemanagement.util.getCompletedManagedIndexMetaData
import org.elasticsearch.indexmanagement.indexstatemanagement.util.getStartingManagedIndexMetaData
import org.elasticsearch.indexmanagement.indexstatemanagement.util.hasDifferentJobInterval
import org.elasticsearch.indexmanagement.indexstatemanagement.util.hasTimedOut
import org.elasticsearch.indexmanagement.indexstatemanagement.util.hasVersionConflict
import org.elasticsearch.indexmanagement.indexstatemanagement.util.isAllowed
import org.elasticsearch.indexmanagement.indexstatemanagement.util.isFailed
import org.elasticsearch.indexmanagement.indexstatemanagement.util.isSafeToChange
import org.elasticsearch.indexmanagement.indexstatemanagement.util.isSuccessfulDelete
import org.elasticsearch.indexmanagement.indexstatemanagement.util.managedIndexConfigIndexRequest
import org.elasticsearch.indexmanagement.indexstatemanagement.util.managedIndexMetadataIndexRequest
import org.elasticsearch.indexmanagement.indexstatemanagement.util.publishLegacyNotification
import org.elasticsearch.indexmanagement.indexstatemanagement.util.sendNotification
import org.elasticsearch.indexmanagement.indexstatemanagement.util.shouldBackoff
import org.elasticsearch.indexmanagement.indexstatemanagement.util.shouldChangePolicy
import org.elasticsearch.indexmanagement.indexstatemanagement.util.updateDisableManagedIndexRequest
...
import org.elasticsearch.indexmanagement.spi.indexstatemanagement.model.ActionMetaData
import org.elasticsearch.indexmanagement.spi.indexstatemanagement.model.ManagedIndexMetaData
import org.elasticsearch.indexmanagement.spi.indexstatemanagement.model.PolicyRetryInfoMetaData
import org.elasticsearch.indexmanagement.spi.indexstatemanagement.model.StateMetaData
...
object ManagedIndexRunner :
     ...
     * and the ilm config metadata for the index will be removed, but if the index is not in the cluster, as it
