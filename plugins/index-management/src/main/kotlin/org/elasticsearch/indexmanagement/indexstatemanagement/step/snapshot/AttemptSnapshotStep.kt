...
package org.elasticsearch.indexmanagement.indexstatemanagement.step.snapshot
...
import org.elasticsearch.indexmanagement.indexstatemanagement.settings.ManagedIndexSettings.Companion.SNAPSHOT_DENY_LIST
    ...
    override suspend fun execute(): Step {
        ...
        try {
            ...
            val createSnapshotRequest = CreateSnapshotRequest()
                .userMetadata(mapOf("snapshot_created" to "INFINI Elasticsearch for Elasticsearch Index Management"))
                .indices(indexName)
