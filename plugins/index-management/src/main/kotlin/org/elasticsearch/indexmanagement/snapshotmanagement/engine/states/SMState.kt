...
package org.elasticsearch.indexmanagement.snapshotmanagement.engine.states

import org.elasticsearch.indexmanagement.snapshotmanagement.engine.states.creation.CreationConditionMetState
import org.elasticsearch.indexmanagement.snapshotmanagement.engine.states.creation.CreationFinishedState
import org.elasticsearch.indexmanagement.snapshotmanagement.engine.states.creation.CreatingState
import org.elasticsearch.indexmanagement.snapshotmanagement.engine.states.creation.CreationStartState
import org.elasticsearch.indexmanagement.snapshotmanagement.engine.states.deletion.DeletionConditionMetState
import org.elasticsearch.indexmanagement.snapshotmanagement.engine.states.deletion.DeletionFinishedState
import org.elasticsearch.indexmanagement.snapshotmanagement.engine.states.deletion.DeletingState
import org.elasticsearch.indexmanagement.snapshotmanagement.engine.states.deletion.DeletionStartState
