...
import org.elasticsearch.indexmanagement.transform.exceptions.TransformSearchServiceException
import org.elasticsearch.indexmanagement.transform.model.BucketSearchResult
import org.elasticsearch.indexmanagement.transform.model.ShardNewDocuments
import org.elasticsearch.indexmanagement.transform.model.Transform
import org.elasticsearch.indexmanagement.transform.model.TransformSearchResult
import org.elasticsearch.indexmanagement.transform.model.TransformStats
import org.elasticsearch.indexmanagement.transform.opensearchapi.retryTransformSearch
import org.elasticsearch.indexmanagement.transform.settings.TransformSettings.Companion.TRANSFORM_JOB_SEARCH_BACKOFF_COUNT
import org.elasticsearch.indexmanagement.transform.settings.TransformSettings.Companion.TRANSFORM_JOB_SEARCH_BACKOFF_MILLIS
import org.elasticsearch.indexmanagement.transform.util.TransformContext
import org.elasticsearch.indexmanagement.util.IndexUtils.Companion.LUCENE_MAX_CLAUSES
...
class TransformSearchService(
    ...
    companion object {
         ...
         * Referring on: https://github.com/elasticsearch-project/OpenSearch/pull/1085
         * https://github.com/elasticsearch-project/documentation-website/blob/main/_opensearch/rest-api/search.md#url-parameters
