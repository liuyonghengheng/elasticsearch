...
fun parseClusterManagerTimeout(request: RestRequest, deprecationLogger: DeprecationLogger, restActionName: String): TimeValue {
    ...
    var timeout = request.paramAsTime("cluster_manager_timeout", MasterNodeRequest.DEFAULT_MASTER_NODE_TIMEOUT)
    ...
    if (request.hasParam("master_timeout")) {
        ...
        if (request.hasParam("cluster_manager_timeout")) {
            throw ElasticsearchParseException(DUPLICATE_PARAMETER_ERROR_MESSAGE)
        }
