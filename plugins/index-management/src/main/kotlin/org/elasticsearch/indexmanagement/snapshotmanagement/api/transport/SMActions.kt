...
import org.elasticsearch.indexmanagement.snapshotmanagement.api.transport.get.GetSMPoliciesResponse
import org.elasticsearch.indexmanagement.snapshotmanagement.api.transport.get.GetSMPolicyResponse
...
object SMActions {
     ...
     */
    const val INDEX_SM_POLICY_ACTION_NAME = "cluster:admin/elasticsearch/snapshot_management/policy/write"
    val INDEX_SM_POLICY_ACTION_TYPE = ActionType(INDEX_SM_POLICY_ACTION_NAME, ::IndexSMPolicyResponse)

    /**
     * [TransportGetSMPolicyAction]
     */
    const val GET_SM_POLICY_ACTION_NAME = "cluster:admin/elasticsearch/snapshot_management/policy/get"
    val GET_SM_POLICY_ACTION_TYPE = ActionType(GET_SM_POLICY_ACTION_NAME, ::GetSMPolicyResponse)

    /**
     * [TransportGetSMPoliciesAction]
     */
    const val GET_SM_POLICIES_ACTION_NAME = "cluster:admin/elasticsearch/snapshot_management/policy/search"
     ...
     */
    const val DELETE_SM_POLICY_ACTION_NAME = "cluster:admin/elasticsearch/snapshot_management/policy/delete"
    val DELETE_SM_POLICY_ACTION_TYPE = ActionType(DELETE_SM_POLICY_ACTION_NAME, ::DeleteResponse)

    /**
     * [TransportExplainSMAction]
     */
    const val EXPLAIN_SM_POLICY_ACTION_NAME = "cluster:admin/elasticsearch/snapshot_management/policy/explain"
    val EXPLAIN_SM_POLICY_ACTION_TYPE = ActionType(EXPLAIN_SM_POLICY_ACTION_NAME, ::ExplainSMPolicyResponse)

    /**
     * [TransportStartSMAction]
     */
    const val START_SM_POLICY_ACTION_NAME = "cluster:admin/elasticsearch/snapshot_management/policy/start"
    val START_SM_POLICY_ACTION_TYPE = ActionType(START_SM_POLICY_ACTION_NAME, ::AcknowledgedResponse)

    /**
     * [TransportStopSMAction]
     */
    const val STOP_SM_POLICY_ACTION_NAME = "cluster:admin/elasticsearch/snapshot_management/policy/stop"
