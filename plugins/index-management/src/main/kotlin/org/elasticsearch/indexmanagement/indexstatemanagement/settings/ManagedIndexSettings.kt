...
package org.elasticsearch.indexmanagement.indexstatemanagement.settings
...
class ManagedIndexSettings {
    companion object {
        ...
        val JOB_INTERVAL: Setting<Int> = Setting.intSetting(
            "plugins.index_lifecycle_management.job_interval",
        ...
        val SWEEP_PERIOD: Setting<TimeValue> = Setting.timeSetting(
            "plugins.index_lifecycle_management.coordinator.sweep_period",
