...
import org.elasticsearch.replication.action.stats.AutoFollowStatsRequest
import org.elasticsearch.replication.action.stats.AutoFollowStatsResponses
import org.elasticsearch.replication.rest.RestURL.AUTOFOLLOW_STATS_URL
...
class AutoFollowStatsHandler : BaseRestHandler() {
    ...
    override fun routes(): List<RestHandler.Route> {
        return listOf(RestHandler.Route(RestRequest.Method.GET, AUTOFOLLOW_STATS_URL))
    }
