...
import org.elasticsearch.replication.action.stats.LeaderStatsRequest
import org.elasticsearch.replication.action.stats.LeaderStatsResponse
import org.elasticsearch.replication.rest.RestURL.LEADER_STATS_URL
...
class LeaderStatsHandler : BaseRestHandler() {
    ...
    override fun routes(): List<RestHandler.Route> {
        return listOf(RestHandler.Route(RestRequest.Method.GET, LEADER_STATS_URL))
    }
