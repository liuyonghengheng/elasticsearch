...
import org.elasticsearch.replication.action.replicationstatedetails.UpdateReplicationStateDetailsRequest
import org.elasticsearch.replication.metadata.state.REPLICATION_LAST_KNOWN_OVERALL_STATE
import org.elasticsearch.replication.metadata.store.*
    ...
    private suspend fun updateMetadata(updateReq: UpdateReplicationMetadataRequest) {
        executeAndWrapExceptionIfAny({
            ...
            if(response.result != DocWriteResponse.Result.CREATED &&
                ...
                throw org.elasticsearch.replication.ReplicationException("Error updating replication metadata")
            }
