...
import org.elasticsearch.sql.legacy.esdomain.mapping.TypeMappings;
...
public class DateFieldFormatter {
    ...
    private static final String FORMAT_DOT_EASYSEARCH_DASHBOARDS_SAMPLE_DATA_LOGS_EXCEPTION = "yyyy-MM-dd'T'HH:mm:ss.SSS'Z'";
    private static final String FORMAT_DOT_EASYSEARCH_DASHBOARDS_SAMPLE_DATA_FLIGHTS_EXCEPTION = "yyyy-MM-dd'T'HH:mm:ss";
    private static final String
        FORMAT_DOT_EASYSEARCH_DASHBOARDS_SAMPLE_DATA_FLIGHTS_EXCEPTION_NO_TIME = "yyyy-MM-dd'T'";
    private static final String FORMAT_DOT_EASYSEARCH_DASHBOARDS_SAMPLE_DATA_ECOMMERCE_EXCEPTION = "yyyy-MM-dd'T'HH:mm:ssXXX";
                ...
                switch (columnFormat) {
                    ...
                    case "strict_date_optional_time":
                        parsedDate = DateUtils.parseDate(
                            columnOriginalDate,
                            FORMAT_DOT_EASYSEARCH_DASHBOARDS_SAMPLE_DATA_LOGS_EXCEPTION,
                            FORMAT_DOT_EASYSEARCH_DASHBOARDS_SAMPLE_DATA_FLIGHTS_EXCEPTION,
                            FORMAT_DOT_EASYSEARCH_DASHBOARDS_SAMPLE_DATA_FLIGHTS_EXCEPTION_NO_TIME,
                            FORMAT_DOT_EASYSEARCH_DASHBOARDS_SAMPLE_DATA_ECOMMERCE_EXCEPTION,
