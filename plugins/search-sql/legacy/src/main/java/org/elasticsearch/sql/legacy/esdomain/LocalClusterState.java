...
public class LocalClusterState {
    ...
    private SearchSettings pluginSettings;
    ...
    public void setPluginSettings(SearchSettings settings) {
     ...
     * it should be moved to domain model layer for all Elasticsearch specific knowledge.
     * <p>
     * Note that cluster state may be change inside Elasticsearch so it's possible to read different state in 2 accesses
