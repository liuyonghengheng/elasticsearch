...
import static org.elasticsearch.sql.legacy.antlr.parser.ElasticsearchLegacySqlParser.AggregateWindowedFunctionContext;
import static org.elasticsearch.sql.legacy.antlr.parser.ElasticsearchLegacySqlParser.AtomTableItemContext;
import static org.elasticsearch.sql.legacy.antlr.parser.ElasticsearchLegacySqlParser.BinaryComparisonPredicateContext;
import static org.elasticsearch.sql.legacy.antlr.parser.ElasticsearchLegacySqlParser.BooleanLiteralContext;
import static org.elasticsearch.sql.legacy.antlr.parser.ElasticsearchLegacySqlParser.ComparisonOperatorContext;
import static org.elasticsearch.sql.legacy.antlr.parser.ElasticsearchLegacySqlParser.ConstantContext;
import static org.elasticsearch.sql.legacy.antlr.parser.ElasticsearchLegacySqlParser.DecimalLiteralContext;
import static org.elasticsearch.sql.legacy.antlr.parser.ElasticsearchLegacySqlParser.FromClauseContext;
import static org.elasticsearch.sql.legacy.antlr.parser.ElasticsearchLegacySqlParser.FullColumnNameContext;
import static org.elasticsearch.sql.legacy.antlr.parser.ElasticsearchLegacySqlParser.FunctionNameBaseContext;
import static org.elasticsearch.sql.legacy.antlr.parser.ElasticsearchLegacySqlParser.InPredicateContext;
import static org.elasticsearch.sql.legacy.antlr.parser.ElasticsearchLegacySqlParser.IsExpressionContext;
import static org.elasticsearch.sql.legacy.antlr.parser.ElasticsearchLegacySqlParser.MathOperatorContext;
import static org.elasticsearch.sql.legacy.antlr.parser.ElasticsearchLegacySqlParser.MinusSelectContext;
import static org.elasticsearch.sql.legacy.antlr.parser.ElasticsearchLegacySqlParser.OuterJoinContext;
import static org.elasticsearch.sql.legacy.antlr.parser.ElasticsearchLegacySqlParser.PredicateContext;
import static org.elasticsearch.sql.legacy.antlr.parser.ElasticsearchLegacySqlParser.RegexpPredicateContext;
import static org.elasticsearch.sql.legacy.antlr.parser.ElasticsearchLegacySqlParser.RootContext;
import static org.elasticsearch.sql.legacy.antlr.parser.ElasticsearchLegacySqlParser.ScalarFunctionCallContext;
import static org.elasticsearch.sql.legacy.antlr.parser.ElasticsearchLegacySqlParser.SelectElementsContext;
import static org.elasticsearch.sql.legacy.antlr.parser.ElasticsearchLegacySqlParser.SelectExpressionElementContext;
import static org.elasticsearch.sql.legacy.antlr.parser.ElasticsearchLegacySqlParser.SelectFunctionElementContext;
import static org.elasticsearch.sql.legacy.antlr.parser.ElasticsearchLegacySqlParser.SimpleTableNameContext;
import static org.elasticsearch.sql.legacy.antlr.parser.ElasticsearchLegacySqlParser.StringLiteralContext;
import static org.elasticsearch.sql.legacy.antlr.parser.ElasticsearchLegacySqlParser.TableAndTypeNameContext;
import static org.elasticsearch.sql.legacy.antlr.parser.ElasticsearchLegacySqlParser.TableSourceBaseContext;
import static org.elasticsearch.sql.legacy.antlr.parser.ElasticsearchLegacySqlParser.TableSourceItemContext;
import static org.elasticsearch.sql.legacy.antlr.parser.ElasticsearchLegacySqlParser.TableSourcesContext;
import static org.elasticsearch.sql.legacy.antlr.parser.ElasticsearchLegacySqlParser.UdfFunctionCallContext;
import static org.elasticsearch.sql.legacy.antlr.parser.ElasticsearchLegacySqlParser.UidContext;
import static org.elasticsearch.sql.legacy.antlr.parser.ElasticsearchLegacySqlParser.UnionSelectContext;
...
import org.elasticsearch.sql.legacy.antlr.parser.ElasticsearchLegacySqlParser.InnerJoinContext;
import org.elasticsearch.sql.legacy.antlr.parser.ElasticsearchLegacySqlParser.QuerySpecificationContext;
import org.elasticsearch.sql.legacy.antlr.parser.ElasticsearchLegacySqlParser.SelectColumnElementContext;
import org.elasticsearch.sql.legacy.antlr.parser.ElasticsearchLegacySqlParser.SubqueryTableItemContext;
import org.elasticsearch.sql.legacy.antlr.parser.ElasticsearchLegacySqlParser.TableNamePatternContext;
import org.elasticsearch.sql.legacy.antlr.parser.ElasticsearchLegacySqlParserBaseVisitor;

/**
 * ANTLR parse tree visitor to drive the analysis process.
 */
public class AntlrSqlParseTreeVisitor<T extends Reducible> extends ElasticsearchLegacySqlParserBaseVisitor<T> {
    ...
    @Override
    public T visitSelectStarElement(ElasticsearchLegacySqlParser.SelectStarElementContext ctx) {
    ...
    @Override
    public T visitConvertedDataType(ElasticsearchLegacySqlParser.ConvertedDataTypeContext ctx) {
    ...
    private boolean isNamedArgument(BinaryComparisonPredicateContext ctx) {
        if (ctx.getParent() != null && ctx.getParent().getParent() != null
            ...
            return parent.scalarFunctionName().functionNameBase().elasticsearchFunctionNameBase() != null;
        }
        return false;
    }
