...
import org.elasticsearch.sql.legacy.antlr.ElasticsearchLegacySqlAnalyzer;
import org.elasticsearch.sql.legacy.antlr.SqlAnalysisConfig;
...
import org.elasticsearch.sql.legacy.executor.ActionRequestRestExecutorFactory;
import org.elasticsearch.sql.legacy.executor.Format;
import org.elasticsearch.sql.legacy.executor.RestExecutor;
import org.elasticsearch.sql.legacy.executor.cursor.CursorActionRequestRestExecutorFactory;
import org.elasticsearch.sql.legacy.executor.cursor.CursorAsyncRestExecutor;
...
import org.elasticsearch.sql.legacy.request.SqlRequestFactory;
import org.elasticsearch.sql.legacy.request.SqlRequestParam;
import org.elasticsearch.sql.legacy.rewriter.matchtoterm.VerificationException;
import org.elasticsearch.sql.legacy.utils.JsonPrettyFormatter;
import org.elasticsearch.sql.legacy.utils.LogUtils;
import org.elasticsearch.sql.legacy.utils.QueryDataAnonymizer;
...
public class RestSqlAction extends BaseRestHandler {
     ...
     * API endpoint path
     */
    public static final String QUERY_API_ENDPOINT = "/_sql";
...
//    public static final String LEGACY_CURSOR_CLOSE_ENDPOINT = LEGACY_QUERY_API_ENDPOINT + "/close";
    ...
    public RestSqlAction(Settings settings, ClusterService clusterService,
                         org.elasticsearch.sql.common.setting.Settings pluginSettings) {
        super();
...
//    }
    ...
    private boolean isSQLFeatureEnabled() {
        boolean isSqlEnabled = LocalClusterState.state().getSettingValue(
            org.elasticsearch.sql.common.setting.Settings.Key.SQL_ENABLED);
    ...
    private static ColumnTypeProvider performAnalysis(String sql) {
        ...
        ElasticsearchLegacySqlAnalyzer analyzer = new ElasticsearchLegacySqlAnalyzer(config);
