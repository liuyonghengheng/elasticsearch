 ...
 * SearchRequestBuilder (Represents Elasticsearch query)
 */
public abstract class QueryAction {
    ...
    /**
     * Prepare the request, and return Elasticsearch request.
     *
     * @return ActionRequestBuilder (Elasticsearch request)
