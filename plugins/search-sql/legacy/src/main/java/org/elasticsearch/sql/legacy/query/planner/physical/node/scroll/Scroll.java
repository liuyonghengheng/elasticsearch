...
import org.elasticsearch.sql.legacy.query.planner.physical.node.BatchPhysicalOperator;
import org.elasticsearch.sql.legacy.query.planner.resource.ResourceManager;

/**
 * Elasticsearch Scroll API as physical implementation of TableScan
 */
public class Scroll extends BatchPhysicalOperator<SearchHit> {

    /**
     * Request to submit to Elasticsearch to scroll over
     */
     ...
     * because Elasticsearch RequestBuilder doesn't allow QueryBuilder inside be changed after added.
     */
