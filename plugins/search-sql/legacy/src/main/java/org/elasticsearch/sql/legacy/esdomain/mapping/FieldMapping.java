...
import org.elasticsearch.sql.legacy.executor.format.DescribeResultSet;
import org.elasticsearch.sql.legacy.utils.StringUtils;

/**
 * Field mapping that parses native Elasticsearch mapping.
 * <p>
 * NOTE that approaches in this class are NOT reliable because of the Elasticsearch mapping query API used.
...
public class FieldMapping {
    ...
    /**
     * Native mapping information returned from Elasticsearch
     */
    ...
    /**
     * Find field type in Elasticsearch Get Field Mapping API response. Note that Get Field Mapping API does NOT return
