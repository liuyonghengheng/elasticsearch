...
package org.elasticsearch.sql.legacy.query.planner.logical;

import static org.elasticsearch.sql.legacy.query.planner.logical.node.Project.Visitor;
...
import org.elasticsearch.sql.legacy.query.join.TableInJoinRequestBuilder;
import org.elasticsearch.sql.legacy.query.planner.core.Config;
import org.elasticsearch.sql.legacy.query.planner.core.Plan;
...
import org.elasticsearch.sql.legacy.query.planner.logical.node.Join;
import org.elasticsearch.sql.legacy.query.planner.logical.node.Join.JoinCondition;
import org.elasticsearch.sql.legacy.query.planner.logical.node.Project;
import org.elasticsearch.sql.legacy.query.planner.logical.node.Sort;
import org.elasticsearch.sql.legacy.query.planner.logical.node.TableScan;
import org.elasticsearch.sql.legacy.query.planner.logical.node.Top;
import org.elasticsearch.sql.legacy.query.planner.logical.rule.ProjectionPushDown;
import org.elasticsearch.sql.legacy.query.planner.logical.rule.SelectionPushDown;
