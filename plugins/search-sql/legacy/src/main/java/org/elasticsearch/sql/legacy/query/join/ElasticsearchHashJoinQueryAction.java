 ...
 */
public class ElasticsearchHashJoinQueryAction extends ElasticsearchJoinQueryAction {

    public ElasticsearchHashJoinQueryAction(Client client, JoinSelect joinSelect) {
