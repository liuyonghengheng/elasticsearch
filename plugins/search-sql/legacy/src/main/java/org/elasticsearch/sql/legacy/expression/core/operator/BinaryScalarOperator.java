...
import static org.elasticsearch.sql.legacy.expression.model.ExprValue.ExprValueKind.DOUBLE_VALUE;
import static org.elasticsearch.sql.legacy.expression.model.ExprValue.ExprValueKind.FLOAT_VALUE;
import static org.elasticsearch.sql.legacy.expression.model.ExprValue.ExprValueKind.INTEGER_VALUE;
import static org.elasticsearch.sql.legacy.expression.model.ExprValue.ExprValueKind.LONG_VALUE;
import static org.elasticsearch.sql.legacy.expression.model.ExprValueUtils.getDoubleValue;
import static org.elasticsearch.sql.legacy.expression.model.ExprValueUtils.getFloatValue;
import static org.elasticsearch.sql.legacy.expression.model.ExprValueUtils.getIntegerValue;
import static org.elasticsearch.sql.legacy.expression.model.ExprValueUtils.getLongValue;
...
import org.elasticsearch.sql.legacy.expression.model.ExprValueFactory;
