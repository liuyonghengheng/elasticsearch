...
import static org.elasticsearch.sql.legacy.utils.StringUtils.format;
import static org.elasticsearch.sql.legacy.utils.StringUtils.isQuoted;
...
import org.elasticsearch.sql.legacy.domain.ScriptMethodField;
...
public class SQLFunctions {
    ...
    public Tuple<String, String> function(String methodName, List<KVValue> paramers, String name,
        ...
        switch (methodName.toLowerCase()) {
            ...
            case "cot":
                // Elasticsearch does not support the function name cot
    ...
    // Elasticsearch behavior: 1-index, supports out-of-bound index
    ...
    // Elasticsearch behavior: both 'start' and return value are 1-index; return 0 if pattern does not exist;
