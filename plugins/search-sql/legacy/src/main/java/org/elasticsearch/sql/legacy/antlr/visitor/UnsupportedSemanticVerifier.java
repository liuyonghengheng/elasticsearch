...
import org.elasticsearch.sql.legacy.antlr.parser.ElasticsearchLegacySqlParser.MathOperatorContext;
import org.elasticsearch.sql.legacy.antlr.parser.ElasticsearchLegacySqlParser.RegexpPredicateContext;
import org.elasticsearch.sql.legacy.antlr.parser.ElasticsearchLegacySqlParser.ScalarFunctionCallContext;
import org.elasticsearch.sql.legacy.exception.SqlFeatureNotImplementedException;
...
public class UnsupportedSemanticVerifier {
    ...
    public static void verify(ScalarFunctionCallContext ctx) {
        ...
        // type (III)
        if (ctx.parent.parent instanceof ElasticsearchLegacySqlParser.FunctionAsAggregatorFunctionContext
            ...
            // type (I) and (II)
        } else if (ctx.parent.parent instanceof ElasticsearchLegacySqlParser.NestedFunctionArgsContext
