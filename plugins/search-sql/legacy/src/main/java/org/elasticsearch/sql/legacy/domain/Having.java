...
import org.elasticsearch.sql.legacy.parser.HavingParser;
import org.elasticsearch.sql.legacy.parser.NestedType;
import org.elasticsearch.sql.legacy.parser.WhereParser;
 ...
 * 2. Explain: translate conditions to Elasticsearch query DSL (Bucket Selector Aggregation)
 */
public class Having {
     ...
     * Elasticsearch makes sure that all sibling runs before bucket selector aggregation.
     *
