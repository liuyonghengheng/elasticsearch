...
import static org.elasticsearch.sql.legacy.antlr.semantic.types.base.ElasticsearchDataType.DATE;
import static org.elasticsearch.sql.legacy.antlr.semantic.types.base.ElasticsearchDataType.GEO_POINT;
 ...
 */
public enum ElasticsearchScalarFunction implements TypeExpression {
    ...
    ElasticsearchScalarFunction(TypeExpressionSpec... specifications) {
