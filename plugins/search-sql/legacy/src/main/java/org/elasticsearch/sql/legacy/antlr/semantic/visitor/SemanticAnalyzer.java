...
import static org.elasticsearch.sql.legacy.utils.StringUtils.unquoteFullColumn;
import static org.elasticsearch.sql.legacy.utils.StringUtils.unquoteSingleField;
...
public class SemanticAnalyzer implements GenericSqlParseTreeVisitor<Type> {
    ...
    private final ElasticsearchMappingLoader mappingLoader;

    private final TypeChecker typeChecker;

    public SemanticAnalyzer(ElasticsearchMappingLoader mappingLoader, TypeChecker typeChecker) {
