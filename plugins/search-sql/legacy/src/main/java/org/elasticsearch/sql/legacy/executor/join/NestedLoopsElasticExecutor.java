...
import org.elasticsearch.sql.legacy.esdomain.ElasticsearchClient;
...
import org.elasticsearch.sql.legacy.query.join.NestedLoopsElasticRequestBuilder;
import org.elasticsearch.sql.legacy.query.join.TableInJoinRequestBuilder;
import org.elasticsearch.sql.legacy.query.maker.Maker;
...
public class NestedLoopsElasticExecutor extends ElasticJoinExecutor {
    ...
    private int combineResultsFromMultiResponses(List<SearchHit> combinedResults, int totalLimit,
        ...
        MultiSearchResponse.Item[] responses = new ElasticsearchClient(client).multiSearch(multiSearchRequest);
