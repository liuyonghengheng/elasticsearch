...
import static org.elasticsearch.sql.protocol.response.format.ErrorFormatter.compactFormat;
import static org.elasticsearch.sql.protocol.response.format.ErrorFormatter.compactJsonify;
import static org.elasticsearch.sql.protocol.response.format.ErrorFormatter.prettyFormat;
import static org.elasticsearch.sql.protocol.response.format.ErrorFormatter.prettyJsonify;
