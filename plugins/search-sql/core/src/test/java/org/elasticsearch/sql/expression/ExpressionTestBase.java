...
import static org.elasticsearch.sql.config.TestConfig.BOOL_TYPE_MISSING_VALUE_FIELD;
import static org.elasticsearch.sql.config.TestConfig.BOOL_TYPE_NULL_VALUE_FIELD;
import static org.elasticsearch.sql.config.TestConfig.DOUBLE_TYPE_MISSING_VALUE_FIELD;
import static org.elasticsearch.sql.config.TestConfig.DOUBLE_TYPE_NULL_VALUE_FIELD;
import static org.elasticsearch.sql.config.TestConfig.INT_TYPE_MISSING_VALUE_FIELD;
import static org.elasticsearch.sql.config.TestConfig.INT_TYPE_NULL_VALUE_FIELD;
import static org.elasticsearch.sql.config.TestConfig.STRING_TYPE_MISSING_VALUE_FIELD;
import static org.elasticsearch.sql.config.TestConfig.STRING_TYPE_NULL_VALUE_FIELD;
...
import static org.elasticsearch.sql.data.model.ExprValueUtils.missingValue;
