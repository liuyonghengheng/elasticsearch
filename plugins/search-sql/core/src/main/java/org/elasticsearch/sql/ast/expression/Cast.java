...
import static org.elasticsearch.sql.expression.function.BuiltinFunctionName.CAST_TO_BOOLEAN;
import static org.elasticsearch.sql.expression.function.BuiltinFunctionName.CAST_TO_BYTE;
import static org.elasticsearch.sql.expression.function.BuiltinFunctionName.CAST_TO_DATE;
import static org.elasticsearch.sql.expression.function.BuiltinFunctionName.CAST_TO_DATETIME;
import static org.elasticsearch.sql.expression.function.BuiltinFunctionName.CAST_TO_DOUBLE;
import static org.elasticsearch.sql.expression.function.BuiltinFunctionName.CAST_TO_FLOAT;
import static org.elasticsearch.sql.expression.function.BuiltinFunctionName.CAST_TO_INT;
import static org.elasticsearch.sql.expression.function.BuiltinFunctionName.CAST_TO_LONG;
import static org.elasticsearch.sql.expression.function.BuiltinFunctionName.CAST_TO_SHORT;
import static org.elasticsearch.sql.expression.function.BuiltinFunctionName.CAST_TO_STRING;
import static org.elasticsearch.sql.expression.function.BuiltinFunctionName.CAST_TO_TIME;
import static org.elasticsearch.sql.expression.function.BuiltinFunctionName.CAST_TO_TIMESTAMP;
