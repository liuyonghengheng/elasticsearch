...
import static org.elasticsearch.sql.search.utils.Utils.indexScan;
import static org.elasticsearch.sql.search.utils.Utils.indexScanAgg;
import static org.elasticsearch.sql.search.utils.Utils.noProjects;
import static org.elasticsearch.sql.search.utils.Utils.projects;
  ...
  void getFieldTypes() {
    ...
    assertThat(
        ...
        allOf(
            ...
            hasEntry("address", (ExprType) ElasticsearchDataType.EASYSEARCH_TEXT),
            ...
            hasEntry("blob", (ExprType) ElasticsearchDataType.EASYSEARCH_BINARY)
        ));
  }
