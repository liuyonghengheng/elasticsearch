...
package org.elasticsearch.sql.search.storage.script.filter.lucene.relevance;
...
public class MatchQuery extends LuceneQuery {
  ...
  private final BiFunction<MatchQueryBuilder, ExprValue, MatchQueryBuilder> zeroTermsQuery =
      (b, v) -> b.zeroTermsQuery(
          org.elasticsearch.index.search.MatchQuery.ZeroTermsQuery.valueOf(v.stringValue()));
