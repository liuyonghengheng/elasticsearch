...
import org.elasticsearch.sql.search.storage.script.aggregation.ExpressionAggregationScriptFactory;
...
public class ExpressionScriptEngine implements ScriptEngine {
   ...
   */
  public static final String EXPRESSION_LANG_NAME = "elasticsearch_query_expression";
