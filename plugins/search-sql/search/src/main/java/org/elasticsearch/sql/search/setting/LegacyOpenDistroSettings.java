...
public class LegacyOpenDistroSettings {
   ...
   * From Elasticsearch 1.0, the new engine is always enabled.
   */
  ...
  /**
   * Deprecated and will be removed then.
   * From Elasticsearch 1.0, the query analysis in legacy engine is disabled.
   */
  ...
  /**
   * Deprecated and will be removed then.
   * From Elasticsearch 1.0, the query analysis suggestion in legacy engine is disabled.
   */
  ...
  /**
   * Deprecated and will be removed then.
   * From Elasticsearch 1.0, the query analysis threshold in legacy engine is disabled.
   */
  ...
  /**
   * Deprecated and will be removed then.
   * From Elasticsearch 1.0, the query response format is default to JDBC format.
   */
  ...
  /**
   * Deprecated and will be removed then.
   * From Elasticsearch 1.0, the cursor feature is enabled by default.
   */
  ...
  /**
   * Deprecated and will be removed then.
   * From Elasticsearch 1.0, the fetch_size in query body will decide whether create the cursor
