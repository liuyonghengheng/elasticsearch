...
import org.elasticsearch.sql.search.response.agg.MetricParser;
...
import org.elasticsearch.sql.search.storage.script.aggregation.dsl.BucketAggregationBuilder;
import org.elasticsearch.sql.search.storage.script.aggregation.dsl.MetricAggregationBuilder;
...
public class AggregationQueryBuilder extends ExpressionNodeVisitor<AggregationBuilder, Object> {
  ...
  public Pair<List<AggregationBuilder>, ElasticsearchAggregationResponseParser>
