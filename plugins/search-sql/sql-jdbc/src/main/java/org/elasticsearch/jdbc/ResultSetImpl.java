...
import org.elasticsearch.jdbc.internal.results.ColumnMetaData;
import org.elasticsearch.jdbc.internal.results.Cursor;
import org.elasticsearch.jdbc.internal.exceptions.ObjectClosedException;
import org.elasticsearch.jdbc.internal.results.Row;
import org.elasticsearch.jdbc.internal.results.Schema;
import org.elasticsearch.jdbc.logging.LoggingSource;
import org.elasticsearch.jdbc.logging.Logger;
import org.elasticsearch.jdbc.protocol.ColumnDescriptor;
import org.elasticsearch.jdbc.internal.JdbcWrapper;
import org.elasticsearch.jdbc.protocol.QueryResponse;
import org.elasticsearch.jdbc.protocol.exceptions.InternalServerErrorException;
import org.elasticsearch.jdbc.protocol.exceptions.ResponseException;
import org.elasticsearch.jdbc.protocol.http.JdbcCursorQueryRequest;
import org.elasticsearch.jdbc.protocol.http.JsonCursorHttpProtocol;
import org.elasticsearch.jdbc.protocol.http.JsonCursorHttpProtocolFactory;
import org.elasticsearch.jdbc.transport.http.HttpTransport;
import org.elasticsearch.jdbc.types.TypeConverter;
import org.elasticsearch.jdbc.types.TypeConverters;
import org.elasticsearch.jdbc.types.UnrecognizedElasticsearchTypeException;
...
public class ResultSetImpl implements ResultSet, JdbcWrapper, LoggingSource {
    ...
    protected <T> T getObjectX(int columnIndex, Class<T> javaClass, Map<String, Object> conversionParams) throws SQLException {
        ...
        final TypeConverter tc = TypeConverters.getInstance(getColumnMetaData(columnIndex).getElasticsearchType().getJdbcType());
        if (null == tc) {
            throw new SQLException("Conversion from " + getColumnMetaData(columnIndex).getElasticsearchType() + " not supported.");
        }
    ...
    private Object getObjectX(int columnIndex, Map<String, Class<?>> map) throws SQLException {
        ...
        if (map != null) {
            columnSQLTypeName = getColumnMetaData(columnIndex).getElasticsearchType().getJdbcType().getName();
