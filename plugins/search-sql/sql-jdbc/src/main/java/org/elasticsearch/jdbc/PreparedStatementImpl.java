...
import org.elasticsearch.jdbc.internal.util.SqlParser;
import org.elasticsearch.jdbc.logging.Logger;
import org.elasticsearch.jdbc.protocol.JdbcDateTimeFormatter;
import org.elasticsearch.jdbc.protocol.JdbcQueryParam;
...
public class PreparedStatementImpl extends StatementImpl implements PreparedStatement {
    ...
    private void setObjectX(int parameterIndex, Object x, int targetSqlType, Map<String, Object> conversionParams)
        ...
        ElasticsearchType openSearchType = ElasticsearchType.fromJdbcType(jdbcType);
