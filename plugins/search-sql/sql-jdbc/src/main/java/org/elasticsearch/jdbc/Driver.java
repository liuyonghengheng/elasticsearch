...
import org.elasticsearch.jdbc.internal.Version;
import org.elasticsearch.jdbc.logging.LoggerFactory;
import org.elasticsearch.jdbc.logging.NoOpLogger;
...
public class Driver implements java.sql.Driver, LoggingSource {
    ...
    public Connection connect(String url, Properties info) throws SQLException {
        ConnectionConfig connectionConfig = ConnectionConfig.builder()
                ...
                .setProperties(info)
                .build();
        org.elasticsearch.jdbc.logging.Logger log = initLog(connectionConfig);
    ...
    static org.elasticsearch.jdbc.logging.Logger initLog(ConnectionConfig connectionConfig) {
        // precedence:
