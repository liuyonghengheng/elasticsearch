...
import org.elasticsearch.jdbc.config.AwsCredentialsProviderProperty;
import org.elasticsearch.jdbc.config.ConnectionConfig;
import org.elasticsearch.jdbc.config.LoginTimeoutConnectionProperty;
import org.elasticsearch.jdbc.config.PasswordConnectionProperty;
import org.elasticsearch.jdbc.config.UserConnectionProperty;
import org.elasticsearch.jdbc.internal.JdbcWrapper;
import org.elasticsearch.jdbc.internal.util.UrlParser;
...
public class ElasticsearchDataSource implements DataSource, JdbcWrapper, LoggingSource {
    ...
    private Connection getConnection(Map<String, Object> overrideProperties)
        ...
        org.elasticsearch.jdbc.logging.Logger log = Driver.initLog(connectionConfig);
