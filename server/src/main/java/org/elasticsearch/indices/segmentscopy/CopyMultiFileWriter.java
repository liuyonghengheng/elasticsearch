...
public class CopyMultiFileWriter extends AbstractRefCounted implements Releasable {

    public CopyMultiFileWriter(Store store, RecoveryState.Index indexState, String tempFilePrefix, Logger logger, Runnable ensureOpen) {
