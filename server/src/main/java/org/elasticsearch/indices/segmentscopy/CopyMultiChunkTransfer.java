 ...
 */
public abstract class CopyMultiChunkTransfer<Source, Request extends CopyMultiChunkTransfer.ChunkRequest> implements Closeable {
    ...
    protected CopyMultiChunkTransfer(Logger logger, ThreadContext threadContext, ActionListener<Void> listener,
