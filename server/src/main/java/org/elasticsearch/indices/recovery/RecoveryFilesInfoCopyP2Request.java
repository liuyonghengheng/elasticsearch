...
public class RecoveryFilesInfoCopyP2Request extends RecoveryTransportRequest {
    ...
    public RecoveryFilesInfoCopyP2Request(StreamInput in) throws IOException {
        super(in);
    ...
    RecoveryFilesInfoCopyP2Request(long recoveryId, long requestSeqNo, ShardId shardId, List<String> phase1FileNames,
