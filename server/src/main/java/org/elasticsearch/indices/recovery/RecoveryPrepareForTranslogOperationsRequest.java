...
class RecoveryPrepareForTranslogOperationsRequest extends RecoveryTransportRequest {
    ...
    RecoveryPrepareForTranslogOperationsRequest(StreamInput in) throws IOException {
        ...
        if (in.getVersion().onOrAfter(Version.V_7_0_0) && in.getVersion().before(Version.V_7_4_0)) {
    ...
    public void writeTo(StreamOutput out) throws IOException {
        ...
        if (out.getVersion().onOrAfter(Version.V_7_0_0) && out.getVersion().before(Version.V_7_4_0)) {
