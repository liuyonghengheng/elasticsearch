...
final class RecoveryCleanFilesP2Response extends TransportResponse {
    final long localCheckpoint;

    RecoveryCleanFilesP2Response(final long localCheckpoint) {
        this.localCheckpoint = localCheckpoint;
    }

    RecoveryCleanFilesP2Response(final StreamInput in) throws IOException {
        super(in);
