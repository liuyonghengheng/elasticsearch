...
package com.infinilabs.dlic.auth.ldap.util;
...
public final class ConfigConstants {
    ...
    public static final String LDAPS_PEMKEY_FILEPATH = "key_file";
    public static final String LDAPS_PEMKEY_CONTENT = "key_file_content";
    public static final String LDAPS_PEMKEY_PASSWORD = "key_secret";
    public static final String LDAPS_PEMCERT_FILEPATH = "cert_file";
    public static final String LDAPS_PEMCERT_CONTENT = "cert_file_content";
    public static final String LDAPS_PEMTRUSTEDCAS_FILEPATH = "ca_file";
    public static final String LDAPS_PEMTRUSTEDCAS_CONTENT = "ca_file_content";
