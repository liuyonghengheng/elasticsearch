...
package com.infinilabs.dlic.util;
...
import com.infinilabs.security.support.PemKeyReader;
...
public class SettingsBasedSSLConfigurator {
    ...
    public static final String PEMKEY_FILEPATH = "key_file";
    public static final String PEMKEY_CONTENT = "key_file_content";
    public static final String PEMKEY_PASSWORD = "key_secret";
    public static final String PEMCERT_FILEPATH = "cert_file";
    public static final String PEMCERT_CONTENT = "cert_file_content";
    public static final String PEMTRUSTEDCAS_CONTENT = "ca_file_content";
    public static final String PEMTRUSTEDCAS_FILEPATH = "ca_file";
