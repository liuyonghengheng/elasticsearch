...
import com.infinilabs.security.support.ConfigHelper;
                ...
                try {
                    ...
                    if(installDefaultConfig.get()) {
                        ...
                        try {
                            ...
                            final String cd = lookupDir != null? (lookupDir+"/") : new Environment(settings, configPath).configFile().toAbsolutePath().toString()+"/security/";
                            ...
                            if(confFile.exists()) {
                                ...
                                try(StoredContext ctx = threadContext.stashContext()) {
                                    ...
                                    if (isSecurityIndexCreated) {
                                        ...
                                        ConfigHelper.uploadFile(client, cd+"role.yml", opendistrosecurityIndex, CType.ROLE, DEFAULT_CONFIG_VERSION);
                                        ConfigHelper.uploadFile(client, cd+"role_mapping.yml", opendistrosecurityIndex, CType.ROLE_MAPPING, DEFAULT_CONFIG_VERSION);
                                        ConfigHelper.uploadFile(client, cd+"user.yml", opendistrosecurityIndex, CType.USER, DEFAULT_CONFIG_VERSION);
                                        ConfigHelper.uploadFile(client, cd+"privilege.yml", opendistrosecurityIndex, CType.PRIVILEGE, DEFAULT_CONFIG_VERSION);
