...
import com.infinilabs.security.dlic.rest.validation.RolesMappingValidator;
...
public class RolesMappingApiAction extends PatchableResourceApiAction {
	private static final List<Route> routes = ImmutableList.of(
			new Route(Method.GET, "/_security/role_mapping/"),
			new Route(Method.GET, "/_security/role_mapping/{name}"),
			new Route(Method.DELETE, "/_security/role_mapping/{name}"),
			new Route(Method.PUT, "/_security/role_mapping/{name}"),
			new Route(Method.PATCH, "/_security/role_mapping/"),
			new Route(Method.PATCH, "/_security/role_mapping/{name}")
	);
