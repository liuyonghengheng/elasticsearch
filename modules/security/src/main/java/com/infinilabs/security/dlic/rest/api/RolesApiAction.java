...
import com.infinilabs.security.dlic.rest.validation.RolesValidator;
...
public class RolesApiAction extends PatchableResourceApiAction {
	private static final List<Route> routes = ImmutableList.of(
			new Route(Method.GET, "/_security/role/"),
			new Route(Method.GET, "/_security/role/{name}"),
			new Route(Method.DELETE, "/_security/role/{name}"),
			new Route(Method.PUT, "/_security/role/{name}"),
			new Route(Method.PATCH, "/_security/role/"),
			new Route(Method.PATCH, "/_security/role/{name}")
	);
