...
import com.infinilabs.security.NonValidatingObjectMapper;
import com.infinilabs.security.ssl.transport.*;
...
import com.infinilabs.security.ssl.http.netty.SecuritySSLNettyHttpServerTransport;
import com.infinilabs.security.ssl.http.netty.ValidatingDispatcher;
import com.infinilabs.security.ssl.rest.SecuritySSLInfoAction;
...
public class SecuritySSLPlugin extends Plugin implements SystemIndexPlugin, NetworkPlugin {
...
//    public SecuritySSLPlugin(final Settings settings, final Path configPath) {
//        this(settings, configPath, false);
//    }

    protected SecuritySSLPlugin(final Settings settings, final Path configPath, boolean disabled) {
        ...
        client = !"node".equals(this.settings.get(SecuritySSLPlugin.CLIENT_TYPE));
    ...
    public Map<String, Supplier<HttpServerTransport>> getHttpTransports(Settings settings, ThreadPool threadPool, BigArrays bigArrays,
        ...
        if (!client && httpSSLEnabled) {
            ...
            return Collections.singletonMap("com.infinilabs.security.ssl.http.netty.SecuritySSLNettyHttpServerTransport", () -> sgsnht);
    ...
    public List<Setting<?>> getSettings() {
        ...
        settings.add(Setting.boolSetting(SSLConfigConstants.SECURITY_SSL_TRANSPORT_SKIP_HOSTNAME_VERIFICATION, true, Property.NodeScope, Property.Filtered));
    ...
    public Settings additionalSettings() {
       ...
       if(!client && httpSSLEnabled) {
           ...
           builder.put(NetworkModule.HTTP_TYPE_KEY, "com.infinilabs.security.ssl.http.netty.SecuritySSLNettyHttpServerTransport");
       }
