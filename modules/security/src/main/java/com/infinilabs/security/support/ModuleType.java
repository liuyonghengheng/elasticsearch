...
import com.infinilabs.security.auth.AuthorizationBackend;
...
import com.infinilabs.security.auth.internal.NoOpAuthenticationBackend;
import com.infinilabs.security.auth.internal.NoOpAuthorizationBackend;
import com.infinilabs.security.http.HTTPBasicAuthenticator;
import com.infinilabs.security.http.HTTPClientCertAuthenticator;
import com.infinilabs.security.http.HTTPProxyAuthenticator;
import com.infinilabs.security.http.proxy.HTTPExtendedProxyAuthenticator;
...
public enum ModuleType implements Serializable {
	...
	REST_MANAGEMENT_API("REST Management API", "com.infinilabs.security.dlic.rest.api.SecurityRestApiActions", Boolean.TRUE),
	DLSFLS("Document- and Field-Level Security", "com.infinilabs.security.configuration.SecurityFlsDlsIndexSearcherWrapper", Boolean.TRUE),
	AUDITLOG("Audit Logging", "com.infinilabs.security.auditlog.impl.AuditLogging", Boolean.TRUE),
	MULTITENANCY("Kibana Multitenancy", "com.infinilabs.security.configuration.PrivilegesInterceptorImpl", Boolean.TRUE),
	LDAP_AUTHENTICATION_BACKEND("LDAP authentication backend", "com.infinilabs.dlic.auth.ldap.backend.LDAPAuthenticationBackend", Boolean.TRUE),
	LDAP_AUTHORIZATION_BACKEND("LDAP authorization backend", "com.infinilabs.dlic.auth.ldap.backend.LDAPAuthorizationBackend", Boolean.TRUE),
	KERBEROS_AUTHENTICATION_BACKEND("Kerberos authentication backend", "com.infinilabs.dlic.auth.http.kerberos.HTTPSpnegoAuthenticator", Boolean.TRUE),
	JWT_AUTHENTICATION_BACKEND("JWT authentication backend", "com.infinilabs.dlic.auth.http.jwt.HTTPJwtAuthenticator", Boolean.TRUE),
	OPENID_AUTHENTICATION_BACKEND("OpenID authentication backend", "com.infinilabs.dlic.auth.http.jwt.keybyoidc.HTTPJwtKeyByOpenIdConnectAuthenticator", Boolean.TRUE),
	SAML_AUTHENTICATION_BACKEND("SAML authentication backend", "com.infinilabs.dlic.auth.http.saml.HTTPSamlAuthenticator", Boolean.TRUE),
	...
	// COMPLIANCE("Compliance", "com.infinilabs.security.compliance.ComplianceIndexingOperationListenerImpl", Boolean.TRUE),
