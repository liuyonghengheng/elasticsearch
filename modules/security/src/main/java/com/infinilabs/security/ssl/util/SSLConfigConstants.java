...
public final class SSLConfigConstants {
    ...
    public static final String SECURITY_SSL_HTTP_PEMKEY_FILEPATH = "security.ssl.http.key_file";
    public static final String SECURITY_SSL_HTTP_PEMKEY_PASSWORD = "security.ssl.http.key_secret";
    public static final String SECURITY_SSL_HTTP_PEMCERT_FILEPATH = "security.ssl.http.cert_file";
    public static final String SECURITY_SSL_HTTP_PEMTRUSTEDCAS_FILEPATH = "security.ssl.http.ca_file";
    public static final String SECURITY_SSL_HTTP_KEYSTORE_PASSWORD = "security.ssl.http.keystore_password";
    public static final String SECURITY_SSL_HTTP_KEYSTORE_KEYPASSWORD = "security.ssl.http.keystore_keypassword";
    ...
    public static final String SECURITY_SSL_HTTP_TRUSTSTORE_PASSWORD = "security.ssl.http.truststore_password";
    ...
    public static final String SECURITY_SSL_TRANSPORT_SKIP_HOSTNAME_VERIFICATION = "security.ssl.transport.skip_domain_verify";
    public static final String SECURITY_SSL_TRANSPORT_ENFORCE_HOSTNAME_VERIFICATION_RESOLVE_HOST_NAME = "security.ssl.transport.resolve_hostname";

    public static final String SECURITY_SSL_TRANSPORT_KEYSTORE_ALIAS = "security.ssl.transport.keystore_alias";
    public static final String SECURITY_SSL_TRANSPORT_SERVER_KEYSTORE_ALIAS = "security.ssl.transport.server.keystore_alias";
    public static final String SECURITY_SSL_TRANSPORT_CLIENT_KEYSTORE_ALIAS = "security.ssl.transport.client.keystore_alias";

    public static final String SECURITY_SSL_TRANSPORT_KEYSTORE_FILEPATH = "security.ssl.transport.keystore_filepath";
    public static final String SECURITY_SSL_TRANSPORT_PEMKEY_FILEPATH = "security.ssl.transport.key_file";
    public static final String SECURITY_SSL_TRANSPORT_PEMKEY_PASSWORD = "security.ssl.transport.key_secret";
    public static final String SECURITY_SSL_TRANSPORT_PEMCERT_FILEPATH = "security.ssl.transport.cert_file";

    public static final String SECURITY_SSL_TRANSPORT_PEMTRUSTEDCAS_FILEPATH = "security.ssl.transport.ca_file";
    public static final String SECURITY_SSL_TRANSPORT_EXTENDED_KEY_USAGE_ENABLED = "security.ssl.transport.extended_key_usage_enabled";
    public static final boolean SECURITY_SSL_TRANSPORT_EXTENDED_KEY_USAGE_ENABLED_DEFAULT = false;
    public static final String SECURITY_SSL_TRANSPORT_SERVER_PEMKEY_FILEPATH = "security.ssl.transport.server.key_file";
    public static final String SECURITY_SSL_TRANSPORT_SERVER_PEMKEY_PASSWORD = "security.ssl.transport.server.key_secret";
    public static final String SECURITY_SSL_TRANSPORT_SERVER_PEMCERT_FILEPATH = "security.ssl.transport.server.cert_file";
    public static final String SECURITY_SSL_TRANSPORT_SERVER_PEMTRUSTEDCAS_FILEPATH = "security.ssl.transport.server.ca_file";
    public static final String SECURITY_SSL_TRANSPORT_CLIENT_PEMKEY_FILEPATH = "security.ssl.transport.client.key_file";
    public static final String SECURITY_SSL_TRANSPORT_CLIENT_PEMKEY_PASSWORD = "security.ssl.transport.client.key_secret";
    public static final String SECURITY_SSL_TRANSPORT_CLIENT_PEMCERT_FILEPATH = "security.ssl.transport.client.cert_file";
    public static final String SECURITY_SSL_TRANSPORT_CLIENT_PEMTRUSTEDCAS_FILEPATH = "security.ssl.transport.client.ca_file";

    public static final String SECURITY_SSL_TRANSPORT_KEYSTORE_PASSWORD = "security.ssl.transport.keystore_password";
    public static final String SECURITY_SSL_TRANSPORT_KEYSTORE_KEYPASSWORD = "security.ssl.transport.keystore_keypassword";
    public static final String SECURITY_SSL_TRANSPORT_SERVER_KEYSTORE_KEYPASSWORD = "security.ssl.transport.server.keystore_keypassword";
    public static final String SECURITY_SSL_TRANSPORT_CLIENT_KEYSTORE_KEYPASSWORD = "security.ssl.transport.client.keystore_keypassword";
    ...
    public static final String SECURITY_SSL_TRANSPORT_SERVER_TRUSTSTORE_ALIAS = "security.ssl.transport.server.truststore_alias";
    public static final String SECURITY_SSL_TRANSPORT_CLIENT_TRUSTSTORE_ALIAS = "security.ssl.transport.client.truststore_alias";

    public static final String SECURITY_SSL_TRANSPORT_TRUSTSTORE_FILEPATH = "security.ssl.transport.truststore_filepath";
    public static final String SECURITY_SSL_TRANSPORT_TRUSTSTORE_PASSWORD = "security.ssl.transport.truststore_password";
    ...
    public static final String SECURITY_SSL_CLIENT_EXTERNAL_CONTEXT_ID = "security.ssl.client.external_context_id";
    public static final String SECURITY_SSL_TRANSPORT_PRINCIPAL_EXTRACTOR_CLASS = "security.ssl.transport.principal_extractor_class";

    public static final String SECURITY_SSL_HTTP_CRL_FILE = "security.ssl.http.crl.file_path";
    public static final String SECURITY_SSL_HTTP_CRL_VALIDATE = "security.ssl.http.crl.validate";
    public static final String SECURITY_SSL_HTTP_CRL_PREFER_CRLFILE_OVER_OCSP = "security.ssl.http.crl.prefer_crlfile_over_ocsp";
    public static final String SECURITY_SSL_HTTP_CRL_CHECK_ONLY_END_ENTITIES = "security.ssl.http.crl.check_only_end_entities";
    public static final String SECURITY_SSL_HTTP_CRL_DISABLE_OCSP = "security.ssl.http.crl.disable_ocsp";
    public static final String SECURITY_SSL_HTTP_CRL_DISABLE_CRLDP = "security.ssl.http.crl.disable_crldp";
    public static final String SECURITY_SSL_HTTP_CRL_VALIDATION_DATE = "security.ssl.http.crl.validation_date";

    public static final String SECURITY_SSL_ALLOW_CLIENT_INITIATED_RENEGOTIATION = "security.ssl.allow_client_initiated_renegotiation";
