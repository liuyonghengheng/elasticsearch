...
import static com.infinilabs.security.DefaultObjectMapper.getOrDefault;
...
public class ComplianceConfig {
    ...
    public ComplianceConfig(
        ...
        this(
                ...
                settings.get(ConfigConstants.SECURITY_AUDIT_CONFIG_DEFAULT_PREFIX + ConfigConstants.SECURITY_AUDIT_ES_INDEX, "'security-auditlog-'YYYY.MM.dd")
        );
    }
    ...
    public static ComplianceConfig from(Settings settings) {
        ...
        //security.compliance.pii_fields:
