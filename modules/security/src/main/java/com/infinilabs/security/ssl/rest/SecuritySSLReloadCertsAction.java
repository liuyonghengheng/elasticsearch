...
package com.infinilabs.security.ssl.rest;
 ...
 * Currently this action serves PUT request for /_security/ssl/http/reloadcerts or /_security/ssl/transport/reloadcerts endpoint
 */
public class SecuritySSLReloadCertsAction extends BaseRestHandler {
    private static final List<Route> routes = Collections.singletonList(
            new Route(PUT, "_security/ssl/{certType}/reloadcerts/")
    );
     ...
     *
     * Sample request:
     * PUT _security/ssl/transport/reloadcerts
     * PUT _security/ssl/http/reloadcerts
     *
                        ...
                        if (odsks != null) {
                            switch (certType) {
                                ...
                                case "transport":
                                    ...
                                    break;
                                default:
                                    builder.field("message", "invalid uri path, please use /_security/ssl/http/reload or " +
                                        "/_security/ssl/transport/reload");
                                    builder.endObject();
