    ...
    public boolean restAuthEnabled() {
        ...
        if(restInitiallyDisabled) {
            if(dcm == null) {
                ...
                if(log.isTraceEnabled()) {
                    log.trace("security.dynamic.disable_rest_auth {}", restDynamicallyDisabled);
                }
    ...
    public boolean transportInterClusterAuthEnabled() {
        ...
        if(interClusterAuthInitiallyDisabled) {
            if(dcm == null) {
                ...
                if(log.isTraceEnabled()) {
                    log.trace("security.dynamic.disable_intertransport_auth {}", interClusterAuthDynamicallyDisabled);
                }
