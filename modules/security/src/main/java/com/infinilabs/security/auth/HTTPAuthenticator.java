...
/**
 * INFINI Elasticsearch Security custom HTTP authenticators need to implement this interface.
 * <p>
...
public interface HTTPAuthenticator {
     ...
     */
    boolean reRequestAuthentication(RestRequest request, final RestChannel channel, AuthCredentials credentials);
}
