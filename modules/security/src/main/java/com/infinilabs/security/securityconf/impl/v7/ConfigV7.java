...
public class ConfigV7 {
    ...
    public ConfigV7(ConfigV6 c6) {
        ...
        dynamic.do_not_fail_on_forbidden = c6.dynamic.do_not_fail_on_forbidden;
    ...
    public static class Dynamic {
        ...
        @Override
        public String toString() {
            return "Dynamic [filtered_alias_mode=" + filtered_alias_mode + ", http=" + http + ", authc=" + authc + ", authz="
                    + authz + "]";
        }
    }
