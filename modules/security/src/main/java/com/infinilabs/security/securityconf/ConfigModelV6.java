...
public class ConfigModelV6 extends ConfigModel {
    ...
    public ConfigModelV6(
            ...
            SecurityDynamicConfiguration<ActionGroupsV6> privilege,
            SecurityDynamicConfiguration<RoleMappingsV6> role_mapping,
        ...
        roleMappingHolder = new RoleMappingHolder(role_mapping, dcm.getHostsResolverMode());
    }
        ...
        return new ActionGroupResolver() {
            ...
            private Set<String> resolve(final SecurityDynamicConfiguration<?> actionGroups, final String entry) {
                ...
                if(actionGroupAsObject != null && actionGroupAsObject instanceof List) {
                    ...
                    for (final String perm: ((ActionGroupsV6) actionGroupAsObject).getPrivileges()) {
                        if (actionGroups.getCEntries().keySet().contains(perm)) {
                            ret.addAll(resolve(actionGroups,perm));
                        } else {
                            ret.add(perm);
                ...
                public SecurityRole call() throws Exception {
                    ...
                    //final Map<String, DynamicConfiguration> permittedAliasesIndices = securityRoleSettings.getGroups(DotPath.of("indices"));
                        ...
                        for (final Entry<String, RoleV6.Index> permittedAliasesIndex : securityRole.getValue().getIndices().entrySet()) {
                            ...
                            final String query = permittedAliasesIndex.getValue().get_dls_();
                            final List<String> field_security = permittedAliasesIndex.getValue().get_fls_();
    ...
    public static class SecurityRole {
        ...
        @Override
        public String toString() {
            return System.lineSeparator() + "  " + name + System.lineSeparator() + "    ipatterns=" + ipatterns + System.lineSeparator() + "    clusterPerms=" + clusterPerms;
        }
    ...
    public static class IndexPattern {
        ...
        public String toString() {
            return System.lineSeparator() + "        indexPattern=" + indexPattern + System.lineSeparator() + "          dlsQuery=" + dlsQuery
                    + System.lineSeparator() + "          field_security=" + field_security + System.lineSeparator() + "          typePerms=" + typePerms;
        }
