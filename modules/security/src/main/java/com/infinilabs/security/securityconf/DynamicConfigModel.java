...
import com.infinilabs.security.auth.AuthDomain;
...
import com.infinilabs.security.auth.limiting.AddressBasedRateLimiter;
import com.infinilabs.security.auth.limiting.UserNameBasedRateLimiter;
...
public abstract class DynamicConfigModel {
    ...
    public DynamicConfigModel() {
        ...
        authImplMap.put("ldap_c", "com.infinilabs.dlic.auth.ldap.backend.LDAPAuthenticationBackend");
        authImplMap.put("ldap_z", "com.infinilabs.dlic.auth.ldap.backend.LDAPAuthorizationBackend");

        authImplMap.put("ldap2_c", "com.infinilabs.dlic.auth.ldap2.LDAPAuthenticationBackend2");
        authImplMap.put("ldap2_z", "com.infinilabs.dlic.auth.ldap2.LDAPAuthorizationBackend2");
        ...
        authImplMap.put("kerberos_h", "com.infinilabs.dlic.auth.http.kerberos.HTTPSpnegoAuthenticator");
        authImplMap.put("jwt_h", "com.infinilabs.dlic.auth.http.jwt.HTTPJwtAuthenticator");
        authImplMap.put("openid_h", "com.infinilabs.dlic.auth.http.jwt.keybyoidc.HTTPJwtKeyByOpenIdConnectAuthenticator");
        authImplMap.put("saml_h", "com.infinilabs.dlic.auth.http.saml.HTTPSamlAuthenticator");
