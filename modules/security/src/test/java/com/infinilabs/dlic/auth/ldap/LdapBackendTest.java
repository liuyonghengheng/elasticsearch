...
import com.infinilabs.dlic.auth.ldap.backend.LDAPAuthorizationBackend;
import com.infinilabs.dlic.auth.ldap.srv.EmbeddedLDAPServer;
import com.infinilabs.dlic.auth.ldap.util.ConfigConstants;
import com.infinilabs.dlic.auth.ldap.util.LdapHelper;
...
public class LdapBackendTest {
    ...
    public void testLdapAuthenticationSSL() throws Exception {
        ...
        final Settings settings = Settings.builder()
                ...
                .put("security.ssl.transport.truststore_filepath", FileHelper.getAbsoluteFilePathFromClassPath("ldap/truststore.jks"))
    ...
    public void testLdapAuthorization() throws Exception {
        ...
        final Settings settings = Settings.builder()
                ...
                // .put("security.authentication.authorization.ldap.userrolename",
                // "(uniqueMember={0})")
                .build();
