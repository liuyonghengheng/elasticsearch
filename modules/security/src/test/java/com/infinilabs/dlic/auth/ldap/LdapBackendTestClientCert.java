...
package com.infinilabs.dlic.auth.ldap;
...
import com.infinilabs.dlic.auth.ldap.backend.LDAPAuthenticationBackend;
import com.infinilabs.dlic.auth.ldap.util.ConfigConstants;
...
public class LdapBackendTestClientCert {
    ...
    public void testNoAuth() throws Exception {
        ...
        final Settings settings = Settings.builder()
                ...
                .put("security.ssl.transport.truststore_filepath", "/Users/temp/security_integration_tests/ldap/ssl-root-ca/truststore.jks")
    ...
    public void testNoAuthY() throws Exception {
        ...
        final Settings settings = Settings.builder()
                ...
                .put(ConfigConstants.LDAP_AUTHC_USERSEARCH, "(uid={0})")
                .put(ConfigConstants.LDAPS_ENABLE_SSL, true)
                .put("security.ssl.transport.truststore_filepath", "/Users/temp/security_integration_tests/ldap/ssl-root-ca/wrong/truststore.jks")
                .put(ConfigConstants.LDAPS_VERIFY_HOSTNAMES, false)
                .put(ConfigConstants.LDAP_AUTHC_USERBASE, "ou=people,dc=example,dc=com")
                .put(ConfigConstants.LDAP_AUTHC_USERNAME_ATTRIBUTE, "uid")
                .put("path.home",".")
    ...
    public void testLdapSslAuth() throws Exception {
        ...
        final Settings settings = Settings.builder()
                ...
                .put(ConfigConstants.LDAP_AUTHC_USERSEARCH, "(uid={0})")
                .put(ConfigConstants.LDAPS_ENABLE_SSL, true)
                .put("security.ssl.transport.keystore_filepath", "/Users/temp/security_integration_tests/ldap/ssl-root-ca/spock-keystore.jks")
                .put("security.ssl.transport.truststore_filepath", "/Users/temp/security_integration_tests/ldap/ssl-root-ca/truststore.jks")
    ...
    public void testLdapSslAuthPem() throws Exception {
        ...
        final Settings settings = Settings.builder()
                ...
                .put(ConfigConstants.LDAP_AUTHC_USERSEARCH, "(uid={0})")
                .put(ConfigConstants.LDAPS_ENABLE_SSL, true)
                .put(ConfigConstants.LDAPS_PEMTRUSTEDCAS_FILEPATH, "/Users/temp/security_integration_tests/ldap/ssl-root-ca/ca/root-ca.pem")
                .put(ConfigConstants.LDAPS_PEMCERT_FILEPATH, "/Users/temp/security_integration_tests/ldap/ssl-root-ca/spock.crtfull.pem")
                .put(ConfigConstants.LDAPS_PEMKEY_FILEPATH, "/Users/temp/security_integration_tests/ldap/ssl-root-ca/spock.key.pem")
    ...
    public void testLdapSslAuthNo() throws Exception {
        ...
        final Settings settings = Settings.builder()
                ...
                .put(ConfigConstants.LDAP_AUTHC_USERSEARCH, "(uid={0})")
                .put(ConfigConstants.LDAPS_ENABLE_SSL, true)
                .put("security.ssl.transport.keystore_filepath", "/Users/temp/security_integration_tests/ldap/ssl-root-ca/kirk-keystore.jks")
                .put("security.ssl.transport.truststore_filepath", "/Users/temp/security_integration_tests/ldap/ssl-root-ca/truststore.jks")
                .put(ConfigConstants.LDAPS_ENABLE_SSL_CLIENT_AUTH, true)
    ...
    public void testLdapAuthenticationSSL() throws Exception {
        ...
        final Settings settings = Settings.builder()
                ...
                .put(ConfigConstants.LDAP_AUTHC_USERSEARCH, "(uid={0})")
                .put(ConfigConstants.LDAPS_ENABLE_SSL, true)
                //.put("security.ssl.transport.keystore_filepath", "/Users/temp/security_integration_tests/ldap/ssl-root-ca/cn=ldapbinder,ou=people,dc=example,dc=com-keystore.jks")
                .put("security.ssl.transport.truststore_filepath", "/Users/temp/security_integration_tests/ldap/ssl-root-ca/truststore.jks")
