...
public class SinkProviderTLSTest {
	...
	public void testTlsConfigurationNoFallback() throws Exception {
		...
		builder.put("security.audit.config.webhook.ssl.ca_file", FileHelper.getAbsoluteFilePathFromClassPath("auditlog/root-ca.pem"));
		builder.put("security.audit.endpoints.endpoint1.config.webhook.ssl.ca_file", FileHelper.getAbsoluteFilePathFromClassPath("auditlog/root-ca.pem"));
		builder.put("security.audit.endpoints.endpoint2.config.webhook.ssl.ca_file_content", FileHelper.loadFile("auditlog/root-ca.pem"));
