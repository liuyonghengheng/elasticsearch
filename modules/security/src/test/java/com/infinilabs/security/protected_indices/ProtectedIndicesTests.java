...
package com.infinilabs.security.protected_indices;
...
public class ProtectedIndicesTests extends SingleClusterTest {
    ...
    // This user is mapped to superuser, but is not mapped to any protectedIndexRoles
    ...
    private static final String generalErrorMessage = String.format("no permissions for [] and User [name=%s, external_roles=[], requestedTenant=null]", indexAccessNoRoleUser);
    // This user is mapped to superuser and protected_index_role1
...
//                .putList(ConfigConstants.SECURITY_PROTECTED_INDICES_ROLES_KEY, protectedIndexRoles)
        ...
        setup(Settings.EMPTY,
                new DynamicSecurityConfig()
                        ...
                        .setSecurityRolesMapping("role_mapping_protected_indices.yml"),
