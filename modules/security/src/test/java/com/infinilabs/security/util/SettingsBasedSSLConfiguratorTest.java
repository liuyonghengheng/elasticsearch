...
import com.infinilabs.security.test.helper.network.SocketUtils;
...
import com.infinilabs.dlic.util.SettingsBasedSSLConfigurator;
import com.infinilabs.dlic.util.SettingsBasedSSLConfigurator.SSLConfig;
...
public class SettingsBasedSSLConfiguratorTest {
    ...
    public void testPemTrust() throws Exception {
        ...
        try (TestServer testServer = new TestServer("sslConfigurator/pem/truststore.jks",
            ...
            Settings settings = Settings.builder()
                    .put("prefix.ca_file", rootCaPemPath.getFileName().toString())
    ...
    public void testPemClientAuth() throws Exception {
        ...
        try (TestServer testServer = new TestServer("sslConfigurator/pem/truststore.jks",
            ...
            Settings settings = Settings.builder()
                    ...
                    .put("prefix.enable_ssl_client_auth", "true").put("prefix.cert_file", "kirk.pem")
                    .put("prefix.key_file", "kirk.key").put("prefix.key_secret", "secret").build();
            Path configPath = rootCaPemPath.getParent();
    ...
    public void testPemClientAuthFailure() throws Exception {
        ...
        try (TestServer testServer = new TestServer("sslConfigurator/pem/truststore.jks",
            ...
            Settings settings = Settings.builder()
                    .put("prefix.ca_file", rootCaPemPath.getFileName().toString())
                    .put("prefix.enable_ssl", "true").put("path.home", rootCaPemPath.getParent().toString())
                    .put("prefix.enable_ssl_client_auth", "true").put("prefix.cert_file", "wrong-kirk.pem")
                    .put("prefix.key_file", "wrong-kirk.key").put("prefix.key_secret", "G0CVtComen4a")
                    .build();
            Path configPath = rootCaPemPath.getParent();
    ...
    public void testJksTrust() throws Exception {
        ...
        try (TestServer testServer = new TestServer("sslConfigurator/jks/truststore.jks",
            ...
            Settings settings = Settings.builder()
                    .put("security.ssl.transport.truststore_filepath", rootCaJksPath.getFileName().toString())
                    .put("security.ssl.transport.truststore_password", "secret").put("prefix.enable_ssl", "true")
