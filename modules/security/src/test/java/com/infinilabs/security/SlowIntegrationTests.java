...
public class SlowIntegrationTests extends SingleClusterTest {
    ...
    public void testCustomInterclusterRequestEvaluator() throws Exception {
        ...
        final Settings settings = Settings.builder()
                .put(ConfigConstants.SECURITY_INTERCLUSTER_REQUEST_EVALUATOR_CLASS, "com.infinilabs.security.AlwaysFalseInterClusterRequestEvaluator")
    ...
    public void testNodeClientDisallowedWithNonServerCertificate() throws Exception {
        ...
        final Settings tcSettings = Settings.builder()
                ...
                .put("discovery.initial_state_timeout","8s")
                .putList("discovery.zen.ping.unicast.hosts", clusterInfo.nodeHost+":"+clusterInfo.nodePort)
                .put("security.ssl.transport.keystore_filepath", FileHelper.getAbsoluteFilePathFromClassPath("kirk-keystore.jks"))
