...
package com.infinilabs.security.test.plugin;
 ...
 * in front of INFINI Elasticsearch Security. This transport just copies the user string from the
...
public class UserInjectorPlugin extends Plugin implements NetworkPlugin {
    ...
    public Map<String, Supplier<HttpServerTransport>> getHttpTransports(Settings settings, ThreadPool threadPool, BigArrays bigArrays,
        ...
        return ImmutableMap.of("com.infinilabs.security.http.UserInjectingServerTransport",
