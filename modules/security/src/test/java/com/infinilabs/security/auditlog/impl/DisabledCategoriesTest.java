...
import com.infinilabs.security.test.AbstractSecurityUnitTest;
import com.infinilabs.security.auditlog.AuditLog;
import com.infinilabs.security.auditlog.helper.MockRestRequest;
...
public class DisabledCategoriesTest {
	...
	public void invalidRestCategoryConfigurationTest() {
		...
		settingsBuilder.put("security.audit.type", TestAuditlogImpl.class.getName());
	...
	public void invalidConfigurationTest() {
		Builder settingsBuilder  = Settings.builder();
		settingsBuilder.put("security.audit.type", "debug");
		settingsBuilder.put("security.audit.config.disabled_categories", "nonexistant, bad_headers");
	...
	public void enableAllCategoryTest() throws Exception {
		...
		// we're using the ExecutorService in AuditLogging, so we need to wait
