...
public class TracingTests extends SingleClusterTest {
    ...
    public void testHTTPTrace() throws Exception {
        ...
        Logger logger = (Logger) LogManager.getLogger("security_action_trace");
        ...
        rh.executePutRequest("_security/audit/config", AuditTestUtils.createAuditPayload(settings), encodeBasicHeader("admin", "admin"));
        ...
        System.out.println("############ check shards");
        System.out.println(rh.executeGetRequest("_security/authinfo",encodeBasicHeader("admin", "admin")));
    ...
    public void testImmutableIndex() throws Exception {
        ...
        RestHelper rh = nonSslRestHelper();
        rh.executePutRequest("_security/audit/config", AuditTestUtils.createAuditPayload(Settings.EMPTY), encodeBasicHeader("admin", "admin"));
