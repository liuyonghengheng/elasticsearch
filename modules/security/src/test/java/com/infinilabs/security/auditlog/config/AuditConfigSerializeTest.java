...
public class AuditConfigSerializeTest {
    ...
    public void testNullDeSerialize() throws IOException {
        ...
        assertEquals(".security", configCompliance.getOpendistrosecurityIndex());
    }
    ...
    public void testCustomSettings() throws IOException {
        ...
        final Settings settings = Settings.builder()
                ...
                .put(ConfigConstants.SECURITY_AUDIT_TYPE_DEFAULT, "internal_elasticsearch")
                .put(ConfigConstants.SECURITY_AUDIT_CONFIG_DEFAULT_PREFIX + ConfigConstants.SECURITY_AUDIT_ES_INDEX,
                        "test-auditlog-index")
                .build();
