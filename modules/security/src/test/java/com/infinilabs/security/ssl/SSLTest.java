...
package com.infinilabs.security.ssl;
...
import com.infinilabs.security.SecurityPlugin;
...
public class SSLTest extends SingleClusterTest {
    ...
    public void testHttps() throws Exception {
        ...
        final Settings settings = Settings.builder().put("security.ssl.transport.enabled", false)
                ...
                .put("security.ssl.http.keystore_filepath", FileHelper. getAbsoluteFilePathFromClassPath("ssl/node-0-keystore.jks"))
                .put("security.ssl.http.truststore_filepath", FileHelper. getAbsoluteFilePathFromClassPath("ssl/truststore.jks"))
                .build();
        ...
        System.out.println(rh.executeSimpleRequest("_security/sslinfo?pretty&show_dn=true"));
        Assert.assertTrue(rh.executeSimpleRequest("_security/sslinfo?pretty&show_dn=true").contains("EMAILADDRESS=unt@tst.com"));
        Assert.assertTrue(rh.executeSimpleRequest("_security/sslinfo?pretty&show_dn=true").contains("local_certificates_list"));
        ...
        Assert.assertFalse(rh.executeSimpleRequest("_nodes/settings?pretty").contains("\"security\""));
    ...
    public void testCipherAndProtocols() throws Exception {
        ...
        Settings settings = Settings.builder().put("security.ssl.transport.enabled", false)
                .put(ConfigConstants.SECURITY_SSL_ONLY, true)
                .put(SSLConfigConstants.SECURITY_SSL_HTTP_KEYSTORE_ALIAS, "node-0").put("security.ssl.http.enabled", true)
                .put(SSLConfigConstants.SECURITY_SSL_HTTP_ENABLE_OPENSSL_IF_AVAILABLE, allowOpenSSL)
                .put(SSLConfigConstants.SECURITY_SSL_TRANSPORT_ENABLE_OPENSSL_IF_AVAILABLE, allowOpenSSL)
                .put("security.ssl.http.clientauth_mode", "REQUIRE")
                .put("security.ssl.http.keystore_filepath", FileHelper. getAbsoluteFilePathFromClassPath("ssl/node-0-keystore.jks"))
                ...
                .put("security.ssl.http.enabled_ciphers","SSL_RSA_EXPORT_WITH_RC4_40_MD5")
                 //WEAK and insecure protocol, do NOT use this, its here for unittesting only!!!
                .put("security.ssl.http.enabled_protocols","SSLv3")
        ...
        try {
            ...
            settings = Settings.builder().put("security.ssl.transport.enabled", true)
                    .put(ConfigConstants.SECURITY_SSL_ONLY, true)
                    .put(SSLConfigConstants.SECURITY_SSL_HTTP_ENABLE_OPENSSL_IF_AVAILABLE, allowOpenSSL)
                    .put(SSLConfigConstants.SECURITY_SSL_TRANSPORT_ENABLE_OPENSSL_IF_AVAILABLE, allowOpenSSL)
                    ...
                    .put("security.ssl.transport.truststore_filepath", FileHelper. getAbsoluteFilePathFromClassPath("ssl/truststore.jks"))
                     //WEAK and insecure cipher, do NOT use this, its here for unittesting only!!!
                    .put("security.ssl.transport.enabled_ciphers","SSL_RSA_EXPORT_WITH_RC4_40_MD5")
                     //WEAK and insecure protocol, do NOT use this, its here for unittesting only!!!
                    .put("security.ssl.transport.enabled_protocols","SSLv3")
                    .put("client.type","node")
                    .put("path.home",".")
                    .build();
    ...
    public void testHttpsOptionalAuth() throws Exception {
        ...
        final Settings settings = Settings.builder().put("security.ssl.transport.enabled", false)
                ...
                .put(SSLConfigConstants.SECURITY_SSL_TRANSPORT_ENABLE_OPENSSL_IF_AVAILABLE, allowOpenSSL)
                .put("security.ssl.http.keystore_filepath", FileHelper. getAbsoluteFilePathFromClassPath("ssl/node-0-keystore.jks"))
                .put("security.ssl.http.truststore_filepath", FileHelper. getAbsoluteFilePathFromClassPath("ssl/truststore.jks")).build();
        ...
        System.out.println(rh.executeSimpleRequest("_security/sslinfo?pretty"));
    ...
    public void testHttpsAndNodeSSL() throws Exception {
        ...
        final Settings settings = Settings.builder().put("security.ssl.transport.enabled", true)
                ...
                .put("security.ssl.transport.keystore_filepath", FileHelper. getAbsoluteFilePathFromClassPath("ssl/node-0-keystore.jks"))
                .put("security.ssl.transport.truststore_filepath", FileHelper. getAbsoluteFilePathFromClassPath("ssl/truststore.jks"))
                .put("security.ssl.transport.skip_domain_verify", true)
                .put("security.ssl.transport.resolve_hostname", false)

                .put("security.ssl.http.enabled", true).put("security.ssl.http.clientauth_mode", "REQUIRE")
                .put("security.ssl.http.keystore_filepath", FileHelper. getAbsoluteFilePathFromClassPath("ssl/node-0-keystore.jks"))
                .put("security.ssl.http.truststore_filepath", FileHelper. getAbsoluteFilePathFromClassPath("ssl/truststore.jks"))
        ...
        System.out.println(rh.executeSimpleRequest("_security/sslinfo?pretty"));
        Assert.assertTrue(rh.executeSimpleRequest("_security/sslinfo?pretty").contains("TLS"));
        Assert.assertTrue(rh.executeSimpleRequest("_security/sslinfo?pretty").length() > 0);
        Assert.assertTrue(rh.executeSimpleRequest("_nodes/settings?pretty").contains(clusterInfo.clustername));
        Assert.assertTrue(rh.executeSimpleRequest("_security/sslinfo?pretty").contains("CN=node-0.example.com,OU=SSL,O=Test,L=Test,C=DE"));
    ...
    public void testHttpsAndNodeSSLFailedCipher() throws Exception {
        ...
        final Settings settings = Settings.builder().put("security.ssl.transport.enabled", true)
                ...
                .put("security.ssl.transport.enabled_ciphers","INVALID_CIPHER")
    ...
    public void testHttpPlainFail() throws Exception {
        ...
        final Settings settings = Settings.builder().put("security.ssl.transport.enabled", false)
                ...
                .put(SSLConfigConstants.SECURITY_SSL_TRANSPORT_ENABLE_OPENSSL_IF_AVAILABLE, allowOpenSSL)
                .put(SSLConfigConstants.SECURITY_SSL_HTTP_KEYSTORE_ALIAS, "node-0").put("security.ssl.http.enabled", true)
                .put("security.ssl.http.clientauth_mode", "OPTIONAL")
                .put("security.ssl.http.keystore_filepath", FileHelper. getAbsoluteFilePathFromClassPath("ssl/node-0-keystore.jks"))
                .put("security.ssl.http.truststore_filepath", FileHelper. getAbsoluteFilePathFromClassPath("ssl/truststore.jks")).build();
    ...
    public void testHttpsNoEnforce() throws Exception {
        ...
        final Settings settings = Settings.builder().put("security.ssl.transport.enabled", false)
                ...
                .put(SSLConfigConstants.SECURITY_SSL_TRANSPORT_ENABLE_OPENSSL_IF_AVAILABLE, allowOpenSSL)
                .put(SSLConfigConstants.SECURITY_SSL_HTTP_KEYSTORE_ALIAS, "node-0").put("security.ssl.http.enabled", true)
                .put("security.ssl.http.clientauth_mode", "NONE")
                .put("security.ssl.http.keystore_filepath", FileHelper. getAbsoluteFilePathFromClassPath("ssl/node-0-keystore.jks"))
                .put("security.ssl.http.truststore_filepath", FileHelper. getAbsoluteFilePathFromClassPath("ssl/truststore.jks")).build();
    ...
    public void testTransportClientSSL() throws Exception {
        ...
        final Settings settings = Settings.builder().put("security.ssl.transport.enabled", true)
                ...
                .put("security.ssl.transport.truststore_filepath", FileHelper. getAbsoluteFilePathFromClassPath("ssl/truststore.jks"))
                .put("security.ssl.transport.skip_domain_verify", true)
                .put("security.ssl.transport.resolve_hostname", false).build();
    ...
    public void testTransportClientSSLExternalContext() throws Exception {
        ...
        final Settings tcSettings = Settings.builder()
                ...
                .put("path.home", ".")
                .put("security.ssl.client.external_context_id", "abcx")
                .build();
    ...
    public void testTransportClientSSLFail() throws Exception {
        ...
        final Settings tcSettings = Settings.builder().put("cluster.name", clusterInfo.clustername)
                ...
                .put("security.ssl.transport.keystore_filepath", FileHelper. getAbsoluteFilePathFromClassPath("ssl/node-0-keystore.jks"))
                .put("security.ssl.transport.truststore_filepath", FileHelper. getAbsoluteFilePathFromClassPath("ssl/truststore_fail.jks"))
                .put("security.ssl.transport.skip_domain_verify", true)
                .put("security.ssl.transport.resolve_hostname", false).build();
    ...
    public void testCustomPrincipalExtractor() throws Exception {
        ...
        final Settings settings = Settings.builder().put("security.ssl.transport.enabled", true)
            ...
            .put("security.ssl.transport.skip_domain_verify", true)
                .put("security.ssl.transport.resolve_hostname", false)
                .put("security.ssl.transport.principal_extractor_class", "com.infinilabs.security.ssl.TestPrincipalExtractor")
                .put(SSLConfigConstants.SECURITY_SSL_HTTP_KEYSTORE_ALIAS, "node-0")
                .put("security.ssl.http.enabled", true)
                .put("security.ssl.http.keystore_filepath", FileHelper. getAbsoluteFilePathFromClassPath("ssl/node-0-keystore.jks"))
                .put("security.ssl.http.truststore_filepath", FileHelper. getAbsoluteFilePathFromClassPath("ssl/truststore.jks")).build();
    ...
    public void testHttpsAndNodeSSLKeyStoreExtendedUsageEnabled() throws Exception {
        ...
        final Settings settings = Settings.builder().put("security.ssl.transport.enabled", true)
            ...
            .put("security.ssl.transport.keystore_filepath", FileHelper. getAbsoluteFilePathFromClassPath("ssl/extended_key_usage/node-0-keystore.jks"))
            .put("security.ssl.transport.truststore_filepath", FileHelper. getAbsoluteFilePathFromClassPath("ssl/extended_key_usage/truststore.jks"))
