...
package com.infinilabs.security.system_indices;
 ...
 *  Refer:    "security.system_indices.enabled"
 *            "security.system_indices.indices";
 */
public class SystemIndicesTests extends SingleClusterTest {
    ...
    private static final String allAccessUser = "admin_superuser";
    private static final Header allAccessUserHeader = encodeBasicHeader(allAccessUser, allAccessUser);
    private static final String generalErrorMessage = String.format("no permissions for [] and User [name=%s, external_roles=[], requestedTenant=null]", allAccessUser);
    ...
    private void setupSystemIndicesDisabledWithSsl() throws Exception {
        ...
        setup(Settings.EMPTY,
                new DynamicSecurityConfig()
                        ...
                        .setSecurityRolesMapping("role_mapping_system_indices.yml"),
                systemIndexSettings,
                true);
    }
