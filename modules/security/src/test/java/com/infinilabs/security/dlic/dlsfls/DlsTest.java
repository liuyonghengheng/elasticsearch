...
public class DlsTest extends AbstractDlsFlsTest{
    ...
    protected void populateData(TransportClient tc) {
        ...
        System.out.println(Strings.toString(tc.search(new SearchRequest().indices(".security")).actionGet()));
    ...
    public void testDls() throws Exception {
        ...
        Assert.assertFalse(res.getBody().contains("_security_dls_query"));
        Assert.assertFalse(res.getBody().contains("_security_fls_fields"));
