...
import com.infinilabs.security.auditlog.routing.AuditMessageRouter;
...
public abstract class AbstractAuditlogiUnitTest extends SingleClusterTest {
    ...
    protected void updateAuditConfig(final String payload) throws Exception {
        ...
        rh.sendAdminCertificate = true;
        rh.keystore = "auditlog/kirk-keystore.jks";
        RestHelper.HttpResponse response = rh.executePutRequest("_security/audit/config", payload, new Header[0]);
