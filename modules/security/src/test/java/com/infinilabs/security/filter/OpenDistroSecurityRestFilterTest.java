...
import com.infinilabs.security.dlic.rest.api.AbstractRestApiUnitTest;
...
public class OpenDistroSecurityRestFilterTest extends AbstractRestApiUnitTest {
    ...
    public void checkWhitelistedApisAreAccessible() throws Exception {
        ...
        response = rh.executePutRequest("_security/whitelist", "{\"enabled\": true, \"requests\": {\"/_cat/nodes\": [\"GET\"],\"/_cat/indices\": [\"GET\"] }}", adminCredsHeader);

        log.warn("the response is:" + rh.executeGetRequest("_security/whitelist", adminCredsHeader));
    ...
    public void checkNonWhitelistedApisAccessibleOnlyBySuperAdmin() throws Exception {
        ...
        rh.keystore = "restapi/kirk-keystore.jks";
        rh.sendAdminCertificate = true;
        response = rh.executePutRequest("_security/whitelist", "{\"enabled\": true, \"requests\": {\"/_cat/nodes\": [\"GET\"],\"/_cat/indices\": [\"GET\"] }}", nonAdminCredsHeader);
    ...
    public void checkAllApisWhenWhitelistingNotEnabled() throws Exception {
        ...
        rh.keystore = "restapi/kirk-keystore.jks";
        rh.sendAdminCertificate = true;
        response = rh.executePutRequest("_security/whitelist", "{\"enabled\": false, \"requests\": {\"/_cat/nodes\": [\"GET\"],\"/_cat/indices\": [\"GET\"] }}", nonAdminCredsHeader);
    ...
    public void checkSpecificRequestMethodWhitelisting() throws Exception{
        ...
        rh.keystore = "restapi/kirk-keystore.jks";
        rh.sendAdminCertificate = true;
        response = rh.executePutRequest("_security/whitelist", "{\"enabled\": true, \"requests\": {\"/_cluster/settings\": [\"GET\"]}}", nonAdminCredsHeader);
