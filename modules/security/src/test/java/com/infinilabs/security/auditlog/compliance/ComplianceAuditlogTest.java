...
public class ComplianceAuditlogTest extends AbstractAuditlogiUnitTest {
    ...
    public void testInternalConfig() throws Exception {
        ...
        Assert.assertTrue(TestAuditlogImpl.sb.toString().contains("user"));
        Assert.assertTrue(TestAuditlogImpl.sb.toString().contains("security_superuser"));
        Assert.assertTrue(TestAuditlogImpl.sb.toString().contains("indices:data/read/suggest"));
        ...
        Assert.assertTrue(TestAuditlogImpl.sb.toString().contains("\\\"op\\\":\\\"remove\\\",\\\"path\\\":\\\"/security_worf\\\""));
        Assert.assertTrue(validateMsgs(TestAuditlogImpl.messages));
    }
