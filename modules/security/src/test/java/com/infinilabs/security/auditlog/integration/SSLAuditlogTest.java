...
import com.infinilabs.security.test.helper.cluster.ClusterHelper;
...
public class SSLAuditlogTest extends AbstractAuditlogiUnitTest {
    ...
    public void testExternalPemUserPass() throws Exception {
        ...
        Settings additionalSettings = Settings.builder()
                .put("security.audit.type", "external_elasticsearch")
                .put("security.audit.config.http_endpoints", monitoringClusterInfo.httpHost+":"+monitoringClusterInfo.httpPort)
                ...
                .put(ConfigConstants.SECURITY_AUDIT_CONFIG_DEFAULT_PREFIX + ConfigConstants.SECURITY_AUDIT_EXTERNAL_ES_ENABLE_SSL, true)
                .put(ConfigConstants.SECURITY_AUDIT_CONFIG_DEFAULT_PREFIX + ConfigConstants.SECURITY_AUDIT_EXTERNAL_ES_ENABLE_SSL_CLIENT_AUTH, false)
                .put(ConfigConstants.SECURITY_AUDIT_CONFIG_DEFAULT_PREFIX + ConfigConstants.SECURITY_AUDIT_EXTERNAL_ES_PEMTRUSTEDCAS_FILEPATH,
                        FileHelper.getAbsoluteFilePathFromClassPath("auditlog/chain-ca.pem"))
                .put(ConfigConstants.SECURITY_AUDIT_CONFIG_DEFAULT_PREFIX + ConfigConstants.SECURITY_AUDIT_EXTERNAL_ES_PEMCERT_FILEPATH,
                        FileHelper.getAbsoluteFilePathFromClassPath("auditlog/spock.crtfull.pem"))
                .put(ConfigConstants.SECURITY_AUDIT_CONFIG_DEFAULT_PREFIX + ConfigConstants.SECURITY_AUDIT_EXTERNAL_ES_PEMKEY_FILEPATH,
                        FileHelper.getAbsoluteFilePathFromClassPath("auditlog/spock.key.pem"))
                .put(ConfigConstants.SECURITY_AUDIT_CONFIG_DEFAULT_PREFIX + ConfigConstants.SECURITY_AUDIT_EXTERNAL_ES_USERNAME,
                        "admin")
                .put(ConfigConstants.SECURITY_AUDIT_CONFIG_DEFAULT_PREFIX + ConfigConstants.SECURITY_AUDIT_EXTERNAL_ES_PASSWORD,
                        "admin")
                .build();
    ...
    public void testExternalPemClientAuth() throws Exception {
        ...
        Settings additionalSettings = Settings.builder()
                ...
                .put(ConfigConstants.SECURITY_AUDIT_RESOLVE_BULK_REQUESTS, true)
                .put(ConfigConstants.SECURITY_AUDIT_CONFIG_DEFAULT_PREFIX + ConfigConstants.SECURITY_AUDIT_EXTERNAL_ES_ENABLE_SSL, true)
                .put(ConfigConstants.SECURITY_AUDIT_CONFIG_DEFAULT_PREFIX + ConfigConstants.SECURITY_AUDIT_EXTERNAL_ES_ENABLE_SSL_CLIENT_AUTH, true)
                .put(ConfigConstants.SECURITY_AUDIT_CONFIG_DEFAULT_PREFIX + ConfigConstants.SECURITY_AUDIT_EXTERNAL_ES_PEMTRUSTEDCAS_FILEPATH,
                        FileHelper.getAbsoluteFilePathFromClassPath("auditlog/chain-ca.pem"))
                .put(ConfigConstants.SECURITY_AUDIT_CONFIG_DEFAULT_PREFIX + ConfigConstants.SECURITY_AUDIT_EXTERNAL_ES_PEMCERT_FILEPATH,
