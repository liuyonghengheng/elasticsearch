...
public class OpenDistroSecuritySSLReloadCertsActionTests extends SingleClusterTest {
    ...
    private final String GET_CERT_DETAILS_ENDPOINT = "_security/ssl/certs";
    private final String RELOAD_TRANSPORT_CERTS_ENDPOINT = "_security/ssl/transport/reloadcerts";
    private final String RELOAD_HTTP_CERTS_ENDPOINT = "_security/ssl/http/reloadcerts";
    ...
    public void testReloadTransportSSLCertsPass() throws Exception {
        ...
        FileHelper.copyFileContents(FileHelper.getAbsoluteFilePathFromClassPath(newCertFilePath).toString(), pemCertFilePath);
        FileHelper.copyFileContents(FileHelper.getAbsoluteFilePathFromClassPath(newKeyFilePath).toString(), pemKeyFilePath);
    ...
    public void testReloadHttpSSLCerts_FailWrongUri() throws Exception {
        ...
        RestHelper.HttpResponse reloadCertsResponse = rh.executePutRequest("_security/ssl/wrong/reloadcerts", null);
        JSONObject expectedResponse = new JSONObject();
        // Note: toString and toJSONString replace / with \/. This helps get rid of the additional \ character.
        expectedResponse.put("message", "invalid uri path, please use /_security/ssl/http/reload or /_security/ssl/transport/reload");
    ...
    public void testSSLReloadFail_NoReloadSet() throws Exception {
        ...
        JSONObject expectedResponse = new JSONObject();
        expectedResponse.appendField("error", "no handler found for uri [/_security/ssl/transport/reloadcerts] and method [PUT]");
        // Note: toString and toJSONString replace / with \/. This helps get rid of the additional \ character.
        final String expectedResponseString = expectedResponse.toString().replace("\\", "");
        Assert.assertEquals(expectedResponseString, reloadCertsResponse.getBody());
    }
    ...
    private void initTestCluster(final String transportPemCertFilePath, final String transportPemKeyFilePath, final String httpPemCertFilePath, final String httpPemKeyFilePath, final boolean sslCertReload) throws Exception {
        final Settings settings = Settings.builder()
            ...
            .put(SSLConfigConstants.SECURITY_SSL_TRANSPORT_SKIP_HOSTNAME_VERIFICATION, false)
