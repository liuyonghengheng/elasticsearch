...
import com.infinilabs.security.test.helper.rules.OpenDistroSecurityTestWatcher;
...
public abstract class AbstractSecurityUnitTest {
    ...
    protected TransportClient getInternalTransportClient(ClusterInfo info, Settings initTransportClientSettings) {
        ...
        Settings tcSettings = Settings.builder()
            ...
            .put("security.ssl.transport.skip_domain_verify", true)
                .put("security.ssl.transport.keystore_filepath",
    ...
    protected void initialize(ClusterHelper clusterHelper, ClusterInfo info, DynamicSecurityConfig securityConfig) {
    ...
    protected Settings.Builder minimumSecuritySettingsBuilder(int node, boolean sslOnly, boolean hasCustomTransportSettings) {
        ...
        if(!sslOnly) {
            builder.putList("security.authcz.admin_dn", "CN=kirk,OU=client,O=client,l=tEst, C=De");
    ...
    protected void initialize(ClusterHelper clusterHelper, ClusterInfo info) {
...
//    }
    ...
    protected boolean hasCustomTransportSettings(Settings customSettings) {
        ...
        return customSettings.get(SSLConfigConstants.SECURITY_SSL_TRANSPORT_PEMCERT_FILEPATH) != null;
    }
}
