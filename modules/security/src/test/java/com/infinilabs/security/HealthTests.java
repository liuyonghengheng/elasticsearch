...
public class HealthTests extends SingleClusterTest {
    ...
    public void testHealth() throws Exception {
        ...
        HttpResponse res;
        Assert.assertEquals(HttpStatus.SC_OK, (res = rh.executeGetRequest("_security/health?pretty&mode=lenient")).getStatusCode());
        System.out.println(res.getBody());
        assertContains(res, "*UP*");
        assertNotContains(res, "*DOWN*");
        assertNotContains(res, "*strict*");

        Assert.assertEquals(HttpStatus.SC_OK, (res = rh.executeGetRequest("_security/health?pretty")).getStatusCode());
        System.out.println(res.getBody());
        assertContains(res, "*UP*");
    ...
    public void testHealthUnitialized() throws Exception {
        ...
        Assert.assertEquals(HttpStatus.SC_SERVICE_UNAVAILABLE, (res = rh.executeGetRequest("_security/health?pretty")).getStatusCode());
        System.out.println(res.getBody());
