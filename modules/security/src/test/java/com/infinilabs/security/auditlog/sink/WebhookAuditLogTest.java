...
import com.infinilabs.security.auditlog.helper.TestHttpHandler;
...
public class WebhookAuditLogTest {
	...
	public void invalidConfFallbackTest() throws Exception {
		...
		Settings settings = Settings.builder()
		        .put("path.home", ".")
		        .put("security.ssl.transport.truststore_filepath",
	...
	public void formatsTest() throws Exception {
		...
		Settings settings = Settings.builder()
				.put("security.audit.config.webhook.url", url)
				.put("path.home", ".")
                .put("security.ssl.transport.truststore_filepath",
                        FileHelper.getAbsoluteFilePathFromClassPath("auditlog/truststore.jks"))
		...
		settings = Settings.builder()
				.put("security.audit.config.webhook.url", url)
				.put("security.audit.config.webhook.format", "idonotexist")
				.put("security.ssl.transport.truststore_filepath",
                        FileHelper.getAbsoluteFilePathFromClassPath("auditlog/truststore.jks"))
				.put("path.home", ".")
				.build();
		...
		settings = Settings.builder()
				.put("security.audit.config.webhook.url", url)
				.put("security.audit.config.webhook.format", "text")
                .put("security.ssl.transport.truststore_filepath",
                        FileHelper.getAbsoluteFilePathFromClassPath("auditlog/truststore.jks"))
				.put("path.home", ".")
				.build();
		...
		settings = Settings.builder()
				.put("security.audit.config.webhook.url", url)
				.put("security.audit.config.webhook.format", "json")
                .put("security.ssl.transport.truststore_filepath",
                        FileHelper.getAbsoluteFilePathFromClassPath("auditlog/truststore.jks"))
                .put("path.home", ".")
				.build();
		...
		settings = Settings.builder()
				.put("security.audit.config.webhook.url", url)
				.put("security.audit.config.webhook.format", "slack")
                .put("security.ssl.transport.truststore_filepath",
                        FileHelper.getAbsoluteFilePathFromClassPath("auditlog/truststore.jks"))
				.put("path.home", ".")
				.build();
	...
	public void postGetHttpTest() throws Exception {
		...
		settings = Settings.builder()
				.put("security.audit.config.webhook.url", url)
				.put("security.audit.config.webhook.format", "URL_PARAMETER_POST")
				.put("path.home", ".")
                .put("security.ssl.transport.truststore_filepath",
                        FileHelper.getAbsoluteFilePathFromClassPath("auditlog/truststore.jks"))
				.build();
		...
		settings = Settings.builder()
				.put("security.audit.config.webhook.url", url)
				.put("security.audit.config.webhook.format", "URL_PARAMETER_GET")
				.put("path.home", ".")
                .put("security.ssl.transport.truststore_filepath",
                        FileHelper.getAbsoluteFilePathFromClassPath("auditlog/truststore.jks"))
				.build();
    ...
    public void httpsTest() throws Exception {
        ...
        Settings settings = Settings.builder()
                ...
                .put("security.audit.config.webhook.format", "slack")
                .put("path.home", ".")
                .put("security.audit.config.webhook.ssl.verify", true)
                .build();
        ...
        settings = Settings.builder()
                .put("security.audit.config.webhook.url", url)
                .put("security.audit.config.webhook.format", "jSoN")
                .put("security.audit.config.webhook.ssl.verify", false)
                .put("path.home", ".")
                .build();
        auditlog = new WebhookSink("name", settings, ConfigConstants.SECURITY_AUDIT_CONFIG_DEFAULT, null, fallback);
        auditlog.store(msg);
        ...
        settings = Settings.builder()
                .put("security.audit.config.webhook.url", url)
                .put("security.audit.config.webhook.format", "jSoN")
                .put("security.ssl.transport.truststore_filepath", FileHelper.getAbsoluteFilePathFromClassPath("auditlog/truststore.jks"))
                .put("security.audit.config.webhook.ssl.verify", true)
                .put("path.home", ".")
                .build();
        auditlog = new WebhookSink("name", settings, ConfigConstants.SECURITY_AUDIT_CONFIG_DEFAULT, null, fallback);
        ...
        settings = Settings.builder()
                .put("security.audit.config.webhook.url", url)
                .put("security.audit.config.webhook.format", "jSoN")
                .put("security.ssl.transport.truststore_filepath", FileHelper.getAbsoluteFilePathFromClassPath("auditlog/truststore_fail.jks"))
                .put("security.audit.config.webhook.ssl.verify", true)
                .put("path.home", ".")
                .build();
        auditlog = new WebhookSink("name", settings, ConfigConstants.SECURITY_AUDIT_CONFIG_DEFAULT, null, fallback);
    ...
    public void httpsTestPemDefault() throws Exception {
        ...
        Settings settings = Settings.builder()
                .put("security.audit.config.webhook.url", url)
                .put("security.audit.config.webhook.format", "jSoN")
                .put("security.audit.config.webhook.ssl.ca_file", FileHelper.getAbsoluteFilePathFromClassPath("auditlog/root-ca.pem"))
                .put("security.audit.config.webhook.ssl.verify", true)
                .put("path.home", ".")
                .build();
        ...
        settings = Settings.builder()
                .put("security.audit.config.webhook.url", url)
                .put("security.audit.config.webhook.format", "jSoN")
                .put("security.audit.config.webhook.ssl.ca_file", "wrong")
                .put("security.ssl.transport.truststore_filepath", FileHelper.getAbsoluteFilePathFromClassPath("auditlog/truststore_fail.jks"))
                .put("security.audit.config.webhook.ssl.verify", true)
                .put("path.home", ".")
                .build();
        ...
        settings = Settings.builder()
                .put("security.audit.config.webhook.url", url)
                .put("security.audit.config.webhook.format", "jSoN")
                .put("security.audit.config.webhook.ssl.ca_file", FileHelper.getAbsoluteFilePathFromClassPath("auditlog/spock.crt.pem"))
                .put("security.audit.config.webhook.ssl.verify", true)
                .put("path.home", ".")
                .build();
        auditlog = new WebhookSink("name", settings, ConfigConstants.SECURITY_AUDIT_CONFIG_DEFAULT, null, fallback);
        ...
        // test default with existing but wrong PEM, fallback present but ca_file takes precedence and must fail
        handler.reset();
        settings = Settings.builder()
                .put("security.audit.config.webhook.url", url)
                .put("security.audit.config.webhook.format", "jSoN")
    ...
    public void httpsTestPemEndpoint() throws Exception {
        ...
        handler.reset();
        Settings settings = Settings.builder()
                .put("security.audit.endpoints.endpoint1.config.webhook.url", url)
                .put("security.audit.endpoints.endpoint1.config.webhook.format", "jSoN")
                .put("security.audit.endpoints.endpoint1.config.webhook.ssl.ca_file", FileHelper.getAbsoluteFilePathFromClassPath("auditlog/root-ca.pem"))
                .put("security.audit.endpoints.endpoint1.config.webhook.ssl.verify", true)
                .put("path.home", ".")
                .build();
        AuditLogSink auditlog = new WebhookSink("name", settings, "security.audit.endpoints.endpoint1.config", null, fallback);
        auditlog.store(msg);
        Assert.assertTrue(handler.method.equals("POST"));
        Assert.assertTrue(handler.body != null);
        Assert.assertTrue(handler.body.contains("{"));
        ...
        settings = Settings.builder()
                ...
                .put("path.home", ".")
                .build();
        auditlog = new WebhookSink("name", settings, "security.audit.endpoints.endpoint1.config", null, fallback);
        auditlog.store(msg);
        Assert.assertTrue(handler.method.equals("POST"));
        Assert.assertTrue(handler.body != null);
        Assert.assertTrue(handler.body.contains("{"));
        ...
        settings = Settings.builder()
                ...
                .put("security.audit.endpoints.endpoint1.config.webhook.format", "jSoN")
                .put("security.audit.endpoints.endpoint1.config.webhook.ssl.verify", true)
                .put("security.audit.endpoints.endpoint1.config.webhook.ssl.ca_file", FileHelper.getAbsoluteFilePathFromClassPath("auditlog/spock.crt.pem"))
                .put("path.home", ".")
                .build();
        auditlog = new WebhookSink("name", settings, "security.audit.endpoints.endpoint1.config", null, fallback);
        auditlog.store(msg);
    ...
    public void httpsTestPemContentEndpoint() throws Exception {
        ...
        Settings settings = Settings.builder()
                .put("security.audit.endpoints.endpoint1.config.webhook.url", url)
                .put("security.audit.endpoints.endpoint1.config.webhook.format", "jSoN")
                .put("security.audit.endpoints.endpoint1.config.webhook.ssl.ca_file_content", FileHelper.loadFile("auditlog/root-ca.pem"))
                .put("security.audit.endpoints.endpoint1.config.webhook.ssl.verify", true)
                .put("path.home", ".")
                .build();
